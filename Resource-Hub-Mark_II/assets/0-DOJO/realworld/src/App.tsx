  ...
  return (
    <div>
      ...
      <Route
        id="favorites"
        renderer={(details) => (
          <Profile type="favorites" username={details.params.username} />
        )}
      />
      <Route
        id="edit-post"
        renderer={(details) => <Editor slug={details.params.slug} />}
      />
      <Route
        id="new-post"
        renderer={(details) => {
      ...
      <Route
        id="article"
        renderer={(details) => <Article slug={details.params.slug} />}
      />
