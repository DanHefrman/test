...
-   REACT
-   <a href="https://reactjs.org/docs/react-api.html" class="btn">https://reactjs.org/docs/react-api.html</a>  
    //------------------------------------------------------------------------------\\
...
<a href="..\..\React.Component" class="btn">//React.Component</a> is an abstract base class, so it rarely makes sense to refer to React.Component directly. ////Instead, you will typically subclass it, and define at least a render() method. <a href="https://reactjs.org/docs/react-component.html" class="btn">https://reactjs.org/docs/react-component.html</a>
