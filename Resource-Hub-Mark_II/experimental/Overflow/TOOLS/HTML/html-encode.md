html-encode by HTTrack Website Copier/3.x \[XR&CO"2014\], Mon, 14 Dec 2020 03:24:53 GMT --&gt;
...
World"s simplest HTML encoder. Just paste your HTML in the form below, press HTML Encode button, and you get escaped HTML. Press button, get HTML. No ads, nonsense or garbage.
...
<span id="copy-to-clipboard">[![](../images/copy-to-clipboard.png "Copy to clipboard")](#)</span> <span id="html-encode-submit-undo" class="undo">[(undo)](#)</span>

Want to decode HTML?

Use the [HTML decoder tool](html-decode)!
