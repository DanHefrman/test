printf by HTTrack Website Copier/3.x \[XR&CO'2014\], Mon, 14 Dec 2020 03:29:10 GMT --&gt;
...
Format Strings with Printf and Sprintf
======================================

web developer and programmer tools
----------------------------------

World's simplest online printf/sprintf output formatter. Just paste your text in the form below, enter format, press Printf button, and printf function get applied to every line of text. Press button, sprintf text. No ads, nonsense or garbage.
...
<span id="copy-to-clipboard">[![](../images/copy-to-clipboard.png "Copy to clipboard")](#)</span> <span id="printf-submit-undo" class="undo">[(undo)](#)</span>
