hex-to-gray by HTTrack Website Copier/3.x \[XR&CO"2014\], Mon, 14 Dec 2020 03:29:26 GMT --&gt;
...
World"s simplest Gray code encoder. Just paste your hexadecimal numbers in the form below, press Convert button, and you get reflected binary code. Press button, get Gray. No ads, nonsense or garbage.
...
<span id="copy-to-clipboard">[![](../images/copy-to-clipboard.png "Copy to clipboard")](#)</span> <span id="hex-to-gray-submit-undo" class="undo">[(undo)](#)</span>

Want to convert Gray code to hexadecimal?

Use the [Gray code to hex converter](gray-to-hex)!
