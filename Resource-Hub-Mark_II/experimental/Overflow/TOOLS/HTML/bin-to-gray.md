bin-to-gray by HTTrack Website Copier/3.x \[XR&CO"2014\], Mon, 14 Dec 2020 03:29:24 GMT --&gt;
...
World"s simplest Gray code calculator. Just paste your binary number in the form below, press Convert button, and you get Gray code. Press button, get binary Gray code. No ads, nonsense or garbage.
...
<span id="copy-to-clipboard">[![](../images/copy-to-clipboard.png "Copy to clipboard")](#)</span> <span id="bin-to-gray-submit-undo" class="undo">[(undo)](#)</span>

Want to convert Gray code to binary?

Use the [Gray code to binary converter](gray-to-bin)!
