xor-decrypt by HTTrack Website Copier/3.x \[XR&CO'2014\], Mon, 14 Dec 2020 03:26:14 GMT --&gt;
...
World's simplest XOR decryptor. Just paste XOR-encoded text in the form below, enter password, press XOR Decrypt button, and you get decrypted text. Press button, get plain text. No ads, nonsense or garbage.
...
<span id="copy-to-clipboard">[![](../images/copy-to-clipboard.png "Copy to clipboard")](#)</span> <span id="xor-decrypt-submit-undo" class="undo">[(undo)](#)</span>

Want to XOR-encrypt text?

Use the [XOR-encrypt tool](xor-encrypt)!
