remove-whitespace by HTTrack Website Copier/3.x \[XR&CO'2014\], Mon, 14 Dec 2020 03:29:06 GMT --&gt;
...
World's simplest whitespace fixer. Just paste your text in the form below, press Remove Spaces and Tabs button, and you get single spaced string. Press button, get text. No ads, nonsense or garbage. The text also gets trimmed.
...
<span id="copy-to-clipboard">[![](../images/copy-to-clipboard.png "Copy to clipboard")](#)</span> <span id="remove-whitespace-submit-undo" class="undo">[(undo)](#)</span>

Want to join text lines?

Use the [join text lines](join-lines) tool!
