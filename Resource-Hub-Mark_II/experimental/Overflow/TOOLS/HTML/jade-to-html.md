jade-to-html by HTTrack Website Copier/3.x \[XR&CO'2014\], Mon, 14 Dec 2020 03:25:07 GMT --&gt;
...
World's simplest Jade to HTML translator. Just paste your Jade in the form below, press Convert button, and you get HTML. Press button, get HTML. No ads, nonsense or garbage.
...
<span id="copy-to-clipboard">[![](../images/copy-to-clipboard.png "Copy to clipboard")](#)</span> <span id="jade-to-html-submit-undo" class="undo">[(undo)](#)</span>

Want to convert HTML to Jade?

Use the [HTML to Jade converter tool](html-to-jade)!
