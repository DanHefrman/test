regex-replace by HTTrack Website Copier/3.x \[XR&CO'2014\], Mon, 14 Dec 2020 03:29:04 GMT --&gt;
...
World's simplest regular expression match replacer. Just paste your text in the form below, press Replace Regexp button, and you get replaced matches. Press button, get text. No ads, nonsense or garbage.
...
<span id="copy-to-clipboard">[![](../images/copy-to-clipboard.png "Copy to clipboard")](#)</span> <span id="regex-replace-submit-undo" class="undo">[(undo)](#)</span>

Want to replace text using simple string replace?

Use the [Text Replacer tool](text-replace)!
