oct-to-bin by HTTrack Website Copier/3.x \[XR&CO'2014\], Mon, 14 Dec 2020 03:29:19 GMT --&gt;
...
World's simplest oct to bin number converter. Just paste your octal numbers in the form below, press Convert button, and you get binary numbers in base 2. Press button, get binary. No ads, nonsense or garbage.
...
<span id="copy-to-clipboard">[![](../images/copy-to-clipboard.png "Copy to clipboard")](#)</span> <span id="oct-to-bin-submit-undo" class="undo">[(undo)](#)</span>

Want to convert binary to octal?

Use the [Bin to oct converter](bin-to-oct)!
