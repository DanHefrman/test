csv-columns-to-rows by HTTrack Website Copier/3.x \[XR&CO"2014\], Mon, 14 Dec 2020 03:25:27 GMT --&gt;
...
Convert Columns to Rows in CSV Files
====================================

web developer and programmer tools
----------------------------------

World"s simplest CSV column and row exchanger. Just paste your CSV in the form below, press Convert CSV button, and columns become rows. Press button, invert CSV. No ads, nonsense or garbage.
...
<span id="copy-to-clipboard">[![](../images/copy-to-clipboard.png "Copy to clipboard")](#)</span> <span id="csv-columns-to-rows-submit-undo" class="undo">[(undo)](#)</span>

Want to extract CSV columns?

Use the [CSV Column Extractor](csv-extract-column) tool!

Want to convert CSV rows to columns?

Use the [Convert CSV Rows to Columns](csv-rows-to-columns) tool!
