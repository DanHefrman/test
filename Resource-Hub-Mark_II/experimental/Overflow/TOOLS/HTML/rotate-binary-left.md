rotate-binary-left by HTTrack Website Copier/3.x \[XR&CO'2014\], Mon, 14 Dec 2020 03:29:31 GMT --&gt;
...
Circularly Left-Shift Bits in a Binary Number
=============================================

web developer and programmer tools
----------------------------------

World's simplest binary number left-rotator. Just paste your binary numbers in the form below, press Rotate Bits Left, and you get all the bits in every number circularly shifted to the left. Press button, rotate bits to the left. No ads, nonsense or garbage.

**Announcement**: We just launched [math tools for developers](../../www.onlinemathtools.com/index68b6.html?msg2). Check it out!

<span id="copy-to-clipboard">[![](../images/copy-to-clipboard.png "Copy to clipboard")](#)</span> <span id="rotate-binary-left-submit-undo" class="undo">[(undo)](#)</span>

Want to rotate binary numbers to the right?

Use the [Rotate Binary to the Right](rotate-binary-right) tool!
