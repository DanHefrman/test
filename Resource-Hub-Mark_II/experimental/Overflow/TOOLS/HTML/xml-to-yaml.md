xml-to-yaml by HTTrack Website Copier/3.x \[XR&CO'2014\], Mon, 14 Dec 2020 03:25:17 GMT --&gt;
...
World's simplest XML to YAML converter. Just paste your XML in the form below, press Convert button, and you get YAML. Press button, get YAML. No ads, nonsense or garbage.
...
<span id="copy-to-clipboard">[![](../images/copy-to-clipboard.png "Copy to clipboard")](#)</span> <span id="xml-to-yaml-submit-undo" class="undo">[(undo)](#)</span>

Want to convert YAML to XML instead?

Use the [YAML to XML converter tool](yaml-to-xml)!
