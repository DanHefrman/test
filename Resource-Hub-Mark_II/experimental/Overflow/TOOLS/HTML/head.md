head by HTTrack Website Copier/3.x \[XR&CO"2014\], Mon, 14 Dec 2020 03:29:10 GMT --&gt;
...
Extract First n Text Lines
==========================

web developer and programmer tools
----------------------------------

World"s simplest online Linux head command. Just paste your text in the form below, press Get First Lines button, and you get first n lines of the text. Press button, get lines. No ads, nonsense or garbage.
...
<span id="copy-to-clipboard">[![](../images/copy-to-clipboard.png "Copy to clipboard")](#)</span> <span id="head-submit-undo" class="undo">[(undo)](#)</span>
...
Want to find a line range?

Use the [Line Range Extractor](extract-lines) tool!
