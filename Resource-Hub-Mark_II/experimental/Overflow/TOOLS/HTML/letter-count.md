letter-count by HTTrack Website Copier/3.x \[XR&CO'2014\], Mon, 14 Dec 2020 03:28:53 GMT --&gt;
...
World's simplest letter counter. Just paste your text in the form below, press Count Characters button, and you get the number of characters in your string. Press button, get letter count. No ads, nonsense or garbage.
...
<span id="copy-to-clipboard">[![](../images/copy-to-clipboard.png "Copy to clipboard")](#)</span> <span id="letter-count-submit-undo" class="undo">[(undo)](#)</span>

Want to find number of words in text?

Use the [Word Count tool](word-count)!
