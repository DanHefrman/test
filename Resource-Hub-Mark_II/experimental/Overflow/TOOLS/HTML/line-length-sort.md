line-length-sort by HTTrack Website Copier/3.x \[XR&CO'2014\], Mon, 14 Dec 2020 03:28:56 GMT --&gt;
...
World's simplest lines sorter. Just paste your text in the form below, press Sort Lines button, and you get sorted lines. Press button, get text. No ads, nonsense or garbage.
...
Sort format: Shortest to longest Longest to shortest

<span id="copy-to-clipboard">[![](../images/copy-to-clipboard.png "Copy to clipboard")](#)</span> <span id="line-length-sort-submit-undo" class="undo">[(undo)](#)</span>

Want to sort lines alphabetically?

Use the [alphabetic line sorter](text-sort) tool!
