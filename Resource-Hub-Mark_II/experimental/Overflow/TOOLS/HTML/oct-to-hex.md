oct-to-hex by HTTrack Website Copier/3.x \[XR&CO'2014\], Mon, 14 Dec 2020 03:29:20 GMT --&gt;
...
World's simplest octal to hex number converter. Just paste your octals in the form below, press Convert button, and you get hexadecimals. Press button, get hex. No ads, nonsense or garbage.
...
<span id="copy-to-clipboard">[![](../images/copy-to-clipboard.png "Copy to clipboard")](#)</span> <span id="oct-to-hex-submit-undo" class="undo">[(undo)](#)</span>

Want to convert hexadecimal to octal?

Use the [Hex to oct converter](hex-to-oct)!
