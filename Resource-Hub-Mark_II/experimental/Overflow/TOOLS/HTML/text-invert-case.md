text-invert-case by HTTrack Website Copier/3.x \[XR&CO'2014\], Mon, 14 Dec 2020 03:28:37 GMT --&gt;
...
World's simplest text case switcher. Just paste text in the form below, press Convert Case button, and you get inverted case text. Press button, get text. No ads, nonsense or garbage. Works with Unicode and UTF8 as well.
...
<span id="copy-to-clipboard">[![](../images/copy-to-clipboard.png "Copy to clipboard")](#)</span> <span id="text-invert-case-submit-undo" class="undo">[(undo)](#)</span>

Need to convert text to uppercase?
