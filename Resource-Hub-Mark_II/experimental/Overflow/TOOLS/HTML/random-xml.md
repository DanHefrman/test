random-xml by HTTrack Website Copier/3.x \[XR&CO'2014\], Mon, 14 Dec 2020 03:29:12 GMT --&gt;
...
World's simplest random XML generator. Just press Generate XML button, and you get a random XML document. Press button, get XML. No ads, nonsense or garbage.
...
<span id="copy-to-clipboard">[![](../images/copy-to-clipboard.png "Copy to clipboard")](#)</span> <span id="random-xml-submit-undo" class="undo">[(undo)](#)</span>
