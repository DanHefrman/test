random-json by HTTrack Website Copier/3.x \[XR&CO'2014\], Mon, 14 Dec 2020 03:29:12 GMT --&gt;
...
Generate Random JSON Data Structures
====================================

web developer and programmer tools
----------------------------------

World's simplest random JSON generator. Just press Generate JSON button, and you get a random JSON data structure. Press button, get JSON. No ads, nonsense or garbage.
...
Max depth: Max elements per level:

<span id="copy-to-clipboard">[![](../images/copy-to-clipboard.png "Copy to clipboard")](#)</span> <span id="random-json-submit-undo" class="undo">[(undo)](#)</span>
