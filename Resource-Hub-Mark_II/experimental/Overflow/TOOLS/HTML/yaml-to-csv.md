yaml-to-csv by HTTrack Website Copier/3.x \[XR&CO'2014\], Mon, 14 Dec 2020 03:25:24 GMT --&gt;
...
World's simplest YAML to CSV converter. Just paste your YAML in the form below, press Convert button, and you get CSV. Press button, get CSV. No ads, nonsense or garbage.
...
<span id="copy-to-clipboard">[![](../images/copy-to-clipboard.png "Copy to clipboard")](#)</span> <span id="yaml-to-csv-submit-undo" class="undo">[(undo)](#)</span>

Want to convert CSV to YAML instead?

Use the [CSV to YAML converter tool](csv-to-yaml)!
