text-to-csv by HTTrack Website Copier/3.x \[XR&CO'2014\], Mon, 14 Dec 2020 03:25:26 GMT --&gt;
...
World's simplest online text to CSV converter. Just paste your text column data in the form below, press Convert Text to CSV button, and you get comma separated values. Press button, get CSV. No ads, nonsense or garbage.
...
<span id="copy-to-clipboard">[![](../images/copy-to-clipboard.png "Copy to clipboard")](#)</span> <span id="text-to-csv-submit-undo" class="undo">[(undo)](#)</span>

Want to convert CSV to text columns instead?

Use the [CSV to Text Columns converter tool](csv-to-text)!
