oct-to-gray by HTTrack Website Copier/3.x \[XR&CO'2014\], Mon, 14 Dec 2020 03:29:25 GMT --&gt;
...
Convert Oct to Gray Code
========================

web developer and programmer tools
----------------------------------

World's simplest octal Gray code calculator. Just paste your octal number in the form below, press Convert button, and you get Gray code. Press button, get octal Gray code. No ads, nonsense or garbage.
...
<span id="copy-to-clipboard">[![](../images/copy-to-clipboard.png "Copy to clipboard")](#)</span> <span id="oct-to-gray-submit-undo" class="undo">[(undo)](#)</span>

Want to convert Gray code to octal?

Use the [Gray code to octal converter](gray-to-oct)!
