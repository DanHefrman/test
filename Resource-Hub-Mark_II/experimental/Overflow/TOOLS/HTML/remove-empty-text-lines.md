...
World's simplest browser-based utility for removing empty lines from text. Load your text in the input form on the left and you'll instantly get text cleared from empty lines in the output area. Powerful, free, and fast. Load plain text – get text without blank lines. Created by developers from team broowserools.
...
<span class="data-type">no empty lines</span> <span class="status"></span>
...
Empty text line remover options

<span class="option-group-legend">Tabs and Spaces</span>

Tabs and spaces removal mode <span class="option-details">Also delete empty-looking lines consisting only of spaces and tabs.</span>

<span class="primary">Empty text line remover tool</span> <span class="secondary">What is a empty text line remover?</span>

With this tool you can clear empty lines from any text. It can remove all completely blank lines (that contain nothing but a newline symbol), and it can also delete lines that contain whitespace symbols, such as spaces and tabs. You can easily manage this in the settings, by checking or unchecking tabs and spaces removal mode checkbox. Textabulous!

<span class="primary">Empty text line remover examples</span> <span class="secondary">Click to use</span>

The Lord of the Rings

In this example, we remove all empty lines from a text dialogue between Gandalf and Bilbo Baggins. As we've enabled tabs-and-spaces-removal-mode, we also clean this text from lines containing just spaces and tabs.

Bilbo Baggins: No, thank you! We don't want any more visitors, well-wishers, or distant relations! Gandalf: And what about very old friends? Bilbo Baggins: Gandalf? Gandalf: Bilbo Baggins. Bilbo Baggins: My dear Gandalf! Gandalf: Good to see you, 111 years old! Who would believe it? You haven't aged a day.
...
This example removes all blank lines from a list of all Solar System planets. However, because we've disabled spaces and tabs removal mode, it leaves lines that contain them intact.
...
<span class="muted"><span class="green">https://</span>onlinetexttools.com/remove-empty-text-lines</span><span class="underline">?input</span>=Bilbo%20Baggins%3A%20No%2C%20thank%20you%21%20We%20don%27t%20want%20any%20more%20visitors%2C%20well-wishers%2C%20or%20distant%20relations%21%0A%20%20%09%20%20%20%0AGandalf%3A%20And%20what%20about%20very%20old%20friends%3F%0A%0ABilbo%20Baggins%3A%20Gandalf%3F%0AGandalf%3A%20Bilbo%20Baggins.%0A%0ABilbo%20Baggins%3A%20My%20dear%20Gandalf%21%0A%0A%20%20%20%20%20%20%20%20%0AGandalf%3A%20Good%20to%20see%20you%2C%20111%20years%20old%21%20Who%20would%20believe%20it%3F%20You%20haven%27t%20aged%20a%20day.&spaces-tabs=true
