shortest-line by HTTrack Website Copier/3.x \[XR&CO'2014\], Mon, 14 Dec 2020 03:29:01 GMT --&gt;
...
World's simplest shortest text line finder. Just paste your text in the form below, press Find Shortest Line button, and you get the shortest line. Press button, get line. No ads, nonsense or garbage. Note: Excludes the empty lines.
...
<span id="copy-to-clipboard">[![](../images/copy-to-clipboard.png "Copy to clipboard")](#)</span> <span id="shortest-line-submit-undo" class="undo">[(undo)](#)</span>

Want to find the longest line?

Use the [longest line finder](longest-line) tool!
