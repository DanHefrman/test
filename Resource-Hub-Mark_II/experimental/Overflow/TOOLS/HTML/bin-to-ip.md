bin-to-ip by HTTrack Website Copier/3.x \[XR&CO"2014\], Mon, 14 Dec 2020 03:25:43 GMT --&gt;
...
World"s simplest binary to IP converter. Just paste your binary IP address in the form below, press Convert to IP button, and you get a normal IP. Press button, get IP. No ads, nonsense or garbage. Works with dot-separated and 32-bit binary IPs.
...
<span id="copy-to-clipboard">[![](../images/copy-to-clipboard.png "Copy to clipboard")](#)</span> <span id="bin-to-ip-submit-undo" class="undo">[(undo)](#)</span>

Want to convert IP to binary instead?

Use the [IP to binary converter tool](ip-to-bin)!
