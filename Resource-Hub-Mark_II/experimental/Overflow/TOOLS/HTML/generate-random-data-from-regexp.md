...
<span class="data-type">random data</span> <span class="status"></span>
...
Random data from regex options

<span class="option-group-legend">Regular Expression</span>

letters: \[a-z\]{1,5}

RegExp <span class="option-details">Enter your regular expression here</span>

<span class="option-group-legend">Generator</span>

Number <span class="option-details">How many results to generate?</span>

<span class="primary">Random data from regex tool</span> <span class="secondary">What is a random data from regex?</span>

This tool does the opposite of what a regular expression matcher does. Instead of matching data, it generates data. Mind blowing!

<span class="primary">Random data from regex examples</span> <span class="secondary">Click to use</span>

Generate random timestamps

This expression generates different 24-hour format timestamps.
...
This regexp randomly generates different IP addresses.
...
Generate random Euro currencies

This example generates random Euro price tags.
...
This expression generates a random sequence of 50 characters because it matches all possible strings that are exactly 50 characters long.
...
<span class="muted"><span class="green">https://</span>onlinerandomtools.com/generate-random-data-from-regexp</span>?&regex=%28%5B01%5D%3F%5B0-9%5D%7C2%5B0-3%5D%29%3A%5B0-5%5D%5B0-9%5D
