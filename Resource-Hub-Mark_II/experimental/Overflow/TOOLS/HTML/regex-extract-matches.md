regex-extract-matches by HTTrack Website Copier/3.x \[XR&CO'2014\], Mon, 14 Dec 2020 03:29:04 GMT --&gt;
...
Extract Text From Regular Expressions
=====================================

web developer and programmer tools
----------------------------------

World's simplest regexp string extractor. Just paste your text in the form below, enter regex, press Extract Matches button, and you get all the data that matches your regular expression. Press button, extract data. No ads, nonsense or garbage.
...
<span id="copy-to-clipboard">[![](../images/copy-to-clipboard.png "Copy to clipboard")](#)</span> <span id="regex-extract-matches-submit-undo" class="undo">[(undo)](#)</span>

Regex:

Want to generate random strings, text and data from regex?

Use the [regex data generator](text-from-regex) tool!
