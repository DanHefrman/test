tsv-replace-column by HTTrack Website Copier/3.x \[XR&CO'2014\], Mon, 14 Dec 2020 03:25:35 GMT --&gt;
...
Substitute one TSV Column with Another Column
=============================================

web developer and programmer tools
----------------------------------

World's simplest online TSV column value replacer. Just paste your TSV and the new column in the forms below, press Replace TSV Column button, and you get a TSV column substituted. Press button, replace column. No ads, nonsense or garbage.
...
<span id="copy-to-clipboard">[![](../images/copy-to-clipboard.png "Copy to clipboard")](#)</span> <span id="tsv-replace-column-submit-undo" class="undo">[(undo)](#)</span>
