ip-to-oct by HTTrack Website Copier/3.x \[XR&CO'2014\], Mon, 14 Dec 2020 03:25:44 GMT --&gt;
...
World's simplest IP to octal converter. Just paste your IP address in the form below, press Convert to Octal button, and you get IP in octal representation. Press button, get an octal IP. No ads, nonsense or garbage.
...
<span id="copy-to-clipboard">[![](../images/copy-to-clipboard.png "Copy to clipboard")](#)</span> <span id="ip-to-oct-submit-undo" class="undo">[(undo)](#)</span>

Want to convert octal to IP instead?

Use the [Octal to IP converter tool](oct-to-ip)!
