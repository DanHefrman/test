utf8-decode by HTTrack Website Copier/3.x \[XR&CO'2014\], Mon, 14 Dec 2020 03:26:00 GMT --&gt;
...
World's simplest UTF8 decoder. Just paste your UTF8-encoded data in the form below, press UTF8 Decode button, and you get text. Press button, get UTF8-decoded text. No ads, nonsense or garbage. Works with ASCII and Unicode strings.
...
<span id="copy-to-clipboard">[![](../images/copy-to-clipboard.png "Copy to clipboard")](#)</span> <span id="utf8-decode-submit-undo" class="undo">[(undo)](#)</span>

Want to UTF8 encode text?

Use the [UTF8 encoder tool](utf8-encode)!
