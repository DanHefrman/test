csv-rows-to-columns by HTTrack Website Copier/3.x \[XR&CO"2014\], Mon, 14 Dec 2020 03:25:27 GMT --&gt;
...
Convert Rows to Columns in CSV Files
====================================

web developer and programmer tools
----------------------------------

World"s simplest CSV row and column exchanger. Just paste your CSV in the form below, press Convert CSV button, and rows become columns. Press button, invert CSV. No ads, nonsense or garbage.
...
<span id="copy-to-clipboard">[![](../images/copy-to-clipboard.png "Copy to clipboard")](#)</span> <span id="csv-rows-to-columns-submit-undo" class="undo">[(undo)](#)</span>
