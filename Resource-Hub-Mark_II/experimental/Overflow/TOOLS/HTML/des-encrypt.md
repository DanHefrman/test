des-encrypt by HTTrack Website Copier/3.x \[XR&CO"2014\], Mon, 14 Dec 2020 03:26:23 GMT --&gt;
...
World"s simplest DES encryptor. Just paste your text in the form below, enter password, press DES Encrypt button, and you get encrypted text. Press button, get DES. No ads, nonsense or garbage.

**Announcement**: We just launched [math tools for developers](../../www.onlinemathtools.com/index68b6.html?msg2). Check it out!

Password:

<span id="copy-to-clipboard">[![](../images/copy-to-clipboard.png "Copy to clipboard")](#)</span> <span id="des-encrypt-submit-undo" class="undo">[(undo)](#)</span>

Want to DES-decrypt text?

Use the [DES-decrypt tool](des-decrypt)!
