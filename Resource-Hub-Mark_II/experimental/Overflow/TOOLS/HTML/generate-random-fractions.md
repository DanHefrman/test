...
Free online random decimal fraction generator. Just press a button and get your random fraction. There are no ads, popups or nonsense, just a random fraction generator. Press a button, get a decimal fraction. Created by developers from team broowserools.
...
<span class="data-type">random fractions</span> <span class="status"></span>
...
Random fraction generator options

<span class="option-group-legend">Fraction Options</span>

Starting fraction <span class="option-details">Start at this fraction</span>

Ending fraction <span class="option-details">End at this fraction</span>

<span class="option-group-legend">Generator Options</span>

Count <span class="option-details">How many fractions to generate?</span>

Precision <span class="option-details">Fraction precision</span>

<span class="primary">Random fraction generator tool</span> <span class="secondary">What is a random fraction generator?</span>

This tool generates random fractions. You can set the starting fraction, ending fraction, how many fractions to generate and precision of each fraction.

<span class="primary">Random fraction generator examples</span> <span class="secondary">Click to use</span>

Generate random fractions between PI and E

This example generates ten random fractions between math constants pi and e. It sets precision to two decimal digits.
...
Generate decimal fractions between -1 and 1

This example generates five decimal fractions between negative one and one with 5 digits of significance.
...
<span class="muted"><span class="green">https://</span>onlinerandomtools.com/generate-random-fractions</span>?&range-start=2.71&range-end=3.14&count=10&precision=2
