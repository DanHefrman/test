json-to-text by HTTrack Website Copier/3.x \[XR&CO'2014\], Mon, 14 Dec 2020 03:25:11 GMT --&gt;
...
World's simplest JSON text extractor. Just paste your JSON in the form below, press Convert button, and you get plain text. Press button, get TXT. No ads, nonsense or garbage.
...
<span id="copy-to-clipboard">[![](../images/copy-to-clipboard.png "Copy to clipboard")](#)</span> <span id="json-to-text-submit-undo" class="undo">[(undo)](#)</span>
