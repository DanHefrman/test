html-prettify by HTTrack Website Copier/3.x \[XR&CO"2014\], Mon, 14 Dec 2020 03:24:56 GMT --&gt;
...
World"s simplest HTML prettifier. Just paste your HTML in the form below, press HTML Prettify button, and you get beautiful and clean HTML. Press button, get HTML. No ads, nonsense or garbage.

**Announcement**: We just launched [math tools for developers](../../www.onlinemathtools.com/index68b6.html?msg2). Check it out!

<span id="copy-to-clipboard">[![](../images/copy-to-clipboard.png "Copy to clipboard")](#)</span> <span id="html-prettify-submit-undo" class="undo">[(undo)](#)</span>

Want to minify HTML?

Use the [HTML minifier tool](html-minify)!
