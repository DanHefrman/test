base32-encode by HTTrack Website Copier/3.x \[XR&CO"2014\], Mon, 14 Dec 2020 03:25:57 GMT --&gt;
...
World"s simplest base32 encoder. Just paste your data in the form below, press Base32 Encode button, and you get base32 encoded data. Press button, get base32. No ads, nonsense or garbage.
...
<span id="copy-to-clipboard">[![](../images/copy-to-clipboard.png "Copy to clipboard")](#)</span> <span id="base32-encode-submit-undo" class="undo">[(undo)](#)</span>

Want to base32 decode?

Use the [base32 decoder tool](base32-decode)!
