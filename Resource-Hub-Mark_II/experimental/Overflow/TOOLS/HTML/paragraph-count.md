paragraph-count by HTTrack Website Copier/3.x \[XR&CO'2014\], Mon, 14 Dec 2020 03:28:54 GMT --&gt;
...
World's simplest text paragraph counter. Just paste your text in the form below, press Find Number of Paragraphs button, and you get the number of paragraphs in your text. Press button, get paragraph count. No ads, nonsense or garbage.
...
<span id="copy-to-clipboard">[![](../images/copy-to-clipboard.png "Copy to clipboard")](#)</span> <span id="paragraph-count-submit-undo" class="undo">[(undo)](#)</span>
