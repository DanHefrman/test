hex-to-bin by HTTrack Website Copier/3.x \[XR&CO"2014\], Mon, 14 Dec 2020 03:29:21 GMT --&gt;
...
World"s simplest hex to binary number converter. Just paste your hexadecimals in the form below, press Convert button, and you get binary numbers. Press button, get bin. No ads, nonsense or garbage.
...
<span id="copy-to-clipboard">[![](../images/copy-to-clipboard.png "Copy to clipboard")](#)</span> <span id="hex-to-bin-submit-undo" class="undo">[(undo)](#)</span>

Want to convert binary to hexadecimal?

Use the [Bin to hex converter](bin-to-hex)!
