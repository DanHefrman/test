oct-to-ip by HTTrack Website Copier/3.x \[XR&CO'2014\], Mon, 14 Dec 2020 03:25:44 GMT --&gt;
...
Convert Octal to IP Address
===========================

web developer and programmer tools
----------------------------------

World's simplest octal to IP converter. Just paste your octal IP address in the form below, press Convert to IP button, and you get a dotted decimal IP. Press button, get IP. No ads, nonsense or garbage. Works with dot-separated octal IPs and octal numbers.
...
<span id="copy-to-clipboard">[![](../images/copy-to-clipboard.png "Copy to clipboard")](#)</span> <span id="oct-to-ip-submit-undo" class="undo">[(undo)](#)</span>

Want to convert IP to octal instead?

Use the [IP to octal converter tool](ip-to-oct)!
