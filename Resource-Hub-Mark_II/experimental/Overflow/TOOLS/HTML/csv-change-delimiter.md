csv-change-delimiter by HTTrack Website Copier/3.x \[XR&CO"2014\], Mon, 14 Dec 2020 03:25:31 GMT --&gt;
...
World"s simplest CSV column delimiter changer. Just paste your CSV in the form below, press Change Delimiter button, and comma delimiter gets changed to something else. Press button, change separator. No ads, nonsense or garbage.
...
<span id="copy-to-clipboard">[![](../images/copy-to-clipboard.png "Copy to clipboard")](#)</span> <span id="csv-change-delimiter-submit-undo" class="undo">[(undo)](#)</span>
...
Want to transpose CSV columns?

Use the [CSV Transposer](csv-transpose) tool!
