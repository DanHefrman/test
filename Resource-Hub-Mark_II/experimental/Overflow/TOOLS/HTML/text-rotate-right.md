text-rotate-right by HTTrack Website Copier/3.x \[XR&CO'2014\], Mon, 14 Dec 2020 03:28:46 GMT --&gt;
...
World's simplest circular character rotator to the right. Just paste your text in the form below, press Rotate String Right button, and you get characters in the string circularly rotated to the right. Press button, rotate text right. No ads, nonsense or garbage.
...
<span id="copy-to-clipboard">[![](../images/copy-to-clipboard.png "Copy to clipboard")](#)</span> <span id="text-rotate-right-submit-undo" class="undo">[(undo)](#)</span>

Want to rotate strings to the left?

Use the [Rotate String to the Left](text-rotate-left) tool!
