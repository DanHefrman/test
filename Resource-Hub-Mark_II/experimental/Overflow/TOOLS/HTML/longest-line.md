longest-line by HTTrack Website Copier/3.x \[XR&CO'2014\], Mon, 14 Dec 2020 03:29:00 GMT --&gt;
...
World's simplest longest text line finder. Just paste your text in the form below, press Find Longest Line button, and you get the longest line. Press button, get line. No ads, nonsense or garbage.
...
<span id="copy-to-clipboard">[![](../images/copy-to-clipboard.png "Copy to clipboard")](#)</span> <span id="longest-line-submit-undo" class="undo">[(undo)](#)</span>

Want to find the shortest line?

Use the [shortest line finder](shortest-line) tool!
