replace-column by HTTrack Website Copier/3.x \[XR&CO'2014\], Mon, 14 Dec 2020 03:25:38 GMT --&gt;
...
Substitute a Column in Arbitrary Delimited Text
===============================================

web developer and programmer tools
----------------------------------

World's simplest delimited column replacer. Just paste your delimited text, string or file in the form below, press Replace Text Column button, and you get that column substituted. Press button, replace column. No ads, nonsense or garbage.

**Announcement**: We just added another two new tools categories –  
[PNG Tools](../../onlinepngtools.com/index0428.html?msg10) and [UTF8 Tools](../../onlineutf8tools.com/index0428.html?msg10). Check them out!
...
<span id="copy-to-clipboard">[![](../images/copy-to-clipboard.png "Copy to clipboard")](#)</span> <span id="replace-column-submit-undo" class="undo">[(undo)](#)</span>
