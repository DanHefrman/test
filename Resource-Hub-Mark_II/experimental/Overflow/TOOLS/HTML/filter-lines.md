filter-lines by HTTrack Website Copier/3.x \[XR&CO"2014\], Mon, 14 Dec 2020 03:29:03 GMT --&gt;
...
World"s simplest pattern matcher. Just paste your text in the form below, press Filter Lines button, and you get lines that contain the given pattern. Press button, get filtered text. No ads, nonsense or garbage.
...
<span id="copy-to-clipboard">[![](../images/copy-to-clipboard.png "Copy to clipboard")](#)</span> <span id="filter-lines-submit-undo" class="undo">[(undo)](#)</span>

Need to filter lines using a regular expression?
