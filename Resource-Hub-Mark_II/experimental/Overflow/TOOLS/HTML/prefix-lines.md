prefix-lines by HTTrack Website Copier/3.x \[XR&CO'2014\], Mon, 14 Dec 2020 03:28:59 GMT --&gt;
...
World's simplest text line prefixer. Just paste your text in the form below, press Prefix Lines button, and you get prefixed strings. Press button, get prefixes. No ads, nonsense or garbage.
...
<span id="copy-to-clipboard">[![](../images/copy-to-clipboard.png "Copy to clipboard")](#)</span> <span id="prefix-lines-submit-undo" class="undo">[(undo)](#)</span>

Want to add suffixes to lines?

Use the [Suffix text lines tool](suffix-lines)!
