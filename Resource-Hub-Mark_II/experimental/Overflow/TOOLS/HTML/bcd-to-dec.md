bcd-to-dec by HTTrack Website Copier/3.x \[XR&CO"2014\], Mon, 14 Dec 2020 03:29:22 GMT --&gt;
...
World"s simplest BCD calculator. Just paste your BCD in the form below, press Convert button, and you get a decimal number. Press button, get decimal. No ads, nonsense or garbage.
...
<span id="copy-to-clipboard">[![](../images/copy-to-clipboard.png "Copy to clipboard")](#)</span> <span id="bcd-to-dec-submit-undo" class="undo">[(undo)](#)</span>

Want to convert decimal to BCD?

Use the [Dec to BCD converter](dec-to-bcd)!
