hms-to-seconds by HTTrack Website Copier/3.x \[XR&CO"2014\], Mon, 14 Dec 2020 03:25:48 GMT --&gt;
...
World"s simplest HH:MM:SS to seconds converter. Just paste your hours:mins:secs in the form below, press Convert HMS button, and you get seconds. Press button, get seconds. No ads, nonsense or garbage.
...
<span id="copy-to-clipboard">[![](../images/copy-to-clipboard.png "Copy to clipboard")](#)</span> <span id="hms-to-seconds-submit-undo" class="undo">[(undo)](#)</span>

Want to convert secs to h:m:s instead?

Use the [Seconds to HMS tool](seconds-to-hms)!
