punycode-decode by HTTrack Website Copier/3.x \[XR&CO'2014\], Mon, 14 Dec 2020 03:26:02 GMT --&gt;
...
World's simplest punydecoder. Just paste your punycode in the form below, press Punydecode button, and you get decoded data. Press button, get text. No ads, nonsense or garbage.
...
<span id="copy-to-clipboard">[![](../images/copy-to-clipboard.png "Copy to clipboard")](#)</span> <span id="punycode-decode-submit-undo" class="undo">[(undo)](#)</span>

Want to Punyencode?

Use the [Puny encoder tool](punycode-encode)!
