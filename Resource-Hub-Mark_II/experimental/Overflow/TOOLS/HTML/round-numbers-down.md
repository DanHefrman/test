round-numbers-down by HTTrack Website Copier/3.x \[XR&CO'2014\], Mon, 14 Dec 2020 03:29:34 GMT --&gt;
...
World's simplest number down rounder. Just paste your numbers in the form below, press Round Down Numbers button, and you get rounded-down numbers. Press button, round-down numbers. No ads, nonsense or garbage.
...
<span id="copy-to-clipboard">[![](../images/copy-to-clipboard.png "Copy to clipboard")](#)</span> <span id="round-numbers-down-submit-undo" class="undo">[(undo)](#)</span>

Want to round numbers up?

Use the [Round Numbers Up](round-numbers-up) tool!
