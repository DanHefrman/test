utf16-encode by HTTrack Website Copier/3.x \[XR&CO'2014\], Mon, 14 Dec 2020 03:26:51 GMT --&gt;
...
World's simplest online UTF16 encoder. Just paste your text in the form below, press UTF16 Encode button, and you get UTF16-encoded data. Press button, get UTF16. No ads, nonsense or garbage. Works with ASCII and Unicode strings.
...
<span id="copy-to-clipboard">[![](../images/copy-to-clipboard.png "Copy to clipboard")](#)</span> <span id="utf16-encode-submit-undo" class="undo">[(undo)](#)</span>

Want to UTF16 decode text?

Use the [UTF16 decoder tool](utf16-decode)!
