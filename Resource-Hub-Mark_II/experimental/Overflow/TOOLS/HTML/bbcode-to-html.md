bbcode-to-html by HTTrack Website Copier/3.x \[XR&CO"2014\], Mon, 14 Dec 2020 03:25:08 GMT --&gt;
...
World"s simplest BB Code to HTML translator. Just paste your Bulletin Board Code in the form below, press Convert button, and you get HTML. Press button, get HTML. No ads, nonsense or garbage. Works with phpBB, MyBB and vBulletin.
...
<span id="copy-to-clipboard">[![](../images/copy-to-clipboard.png "Copy to clipboard")](#)</span> <span id="bbcode-to-html-submit-undo" class="undo">[(undo)](#)</span>

Want to convert HTML to BBCode?
