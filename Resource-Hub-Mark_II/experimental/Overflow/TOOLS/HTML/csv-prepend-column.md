csv-prepend-column by HTTrack Website Copier/3.x \[XR&CO"2014\], Mon, 14 Dec 2020 03:25:29 GMT --&gt;
...
Add a CSV Column at the Beginning of CSV
========================================

web developer and programmer tools
----------------------------------

World"s simplest online CSV column prepender. Just paste your CSV and the new column in the forms below, press Prepend a CSV Column button, and a new column gets added at the beginning of CSV. Press button, prepend column. No ads, nonsense or garbage.
...
<span id="copy-to-clipboard">[![](../images/copy-to-clipboard.png "Copy to clipboard")](#)</span> <span id="csv-prepend-column-submit-undo" class="undo">[(undo)](#)</span>

Want to append CSV columns?

Use the [Append CSV Columns](csv-append-column) tool!
...
Use the [Replace CSV Columns](csv-replace-column) tool!
