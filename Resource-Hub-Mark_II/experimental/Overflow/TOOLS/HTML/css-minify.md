css-minify by HTTrack Website Copier/3.x \[XR&CO"2014\], Mon, 14 Dec 2020 03:25:02 GMT --&gt;
...
World"s simplest CSS minifier. Just paste your CSS in the form below, press CSS Minify button, and you get compressed CSS. Press button, get CSS. No ads, nonsense or garbage.
...
<span id="copy-to-clipboard">[![](../images/copy-to-clipboard.png "Copy to clipboard")](#)</span> <span id="css-minify-submit-undo" class="undo">[(undo)](#)</span>

Want to prettify CSS?

Use the [CSS prettifier tool](css-prettify)!
