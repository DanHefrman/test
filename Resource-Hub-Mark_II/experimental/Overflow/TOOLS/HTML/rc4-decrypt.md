rc4-decrypt by HTTrack Website Copier/3.x \[XR&CO'2014\], Mon, 14 Dec 2020 03:26:22 GMT --&gt;
...
World's simplest RC4 decryptor. Just paste your text in the form below, enter password, press RC4 Decrypt button, and you get decrypted message. Press button, get text. No ads, nonsense or garbage.

**Announcement**: We just launched [math tools for developers](../../www.onlinemathtools.com/index68b6.html?msg2). Check it out!

Password:

<span id="copy-to-clipboard">[![](../images/copy-to-clipboard.png "Copy to clipboard")](#)</span> <span id="rc4-decrypt-submit-undo" class="undo">[(undo)](#)</span>

Want to RC4-encrypt text?

Use the [RC4-encrypt tool](rc4-encrypt)!
