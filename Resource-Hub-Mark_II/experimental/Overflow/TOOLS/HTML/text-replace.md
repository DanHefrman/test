text-replace by HTTrack Website Copier/3.x \[XR&CO'2014\], Mon, 14 Dec 2020 03:28:41 GMT --&gt;
...
World's simplest text replacement tool. Just paste your text in the form below, press Replace Text button, and you get replaced string. Press button, get string. No ads, nonsense or garbage.
...
<span id="copy-to-clipboard">[![](../images/copy-to-clipboard.png "Copy to clipboard")](#)</span> <span id="text-replace-submit-undo" class="undo">[(undo)](#)</span>

Want to replace text using regular expressions?

Use the [Text Regex Replacer tool](regex-replace)!
