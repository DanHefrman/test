rc4-encrypt by HTTrack Website Copier/3.x \[XR&CO'2014\], Mon, 14 Dec 2020 03:26:21 GMT --&gt;
...
World's simplest RC4 encryptor. Just paste your text in the form below, enter password, press RC4 Encrypt button, and you get encrypted text. Press button, get RC4. No ads, nonsense or garbage.
...
<span id="copy-to-clipboard">[![](../images/copy-to-clipboard.png "Copy to clipboard")](#)</span> <span id="rc4-encrypt-submit-undo" class="undo">[(undo)](#)</span>

Want to RC4-decrypt text?

Use the [RC4-decrypt tool](rc4-decrypt)!
