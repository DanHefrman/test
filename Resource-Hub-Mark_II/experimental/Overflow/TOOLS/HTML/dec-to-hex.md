dec-to-hex by HTTrack Website Copier/3.x \[XR&CO"2014\], Mon, 14 Dec 2020 03:29:21 GMT --&gt;
...
World"s simplest decimal converter. Just paste your dec number in the form below, press Convert button, and you get a hex number in base 16. Press button, get hexadecimal. No ads, nonsense or garbage.
...
<span id="copy-to-clipboard">[![](../images/copy-to-clipboard.png "Copy to clipboard")](#)</span> <span id="dec-to-hex-submit-undo" class="undo">[(undo)](#)</span>

Want to convert hex to dec?

Use the [Hex to dec converter](hex-to-dec)!
