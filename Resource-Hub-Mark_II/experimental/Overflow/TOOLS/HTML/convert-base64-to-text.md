...
World"s simplest browser-based utility for decoding base64 to text. Load your base64 in the input form on the left and you"ll instantly get plain text in the output area. Powerful, free, and fast. Load base64 – get text. Created by developers from team broowserools.
...
<span class="primary">Base64 to text decoder tool</span> <span class="secondary">What is a base64 to text decoder?</span>

With this tool you can convert data encoded in base64 to plain text. It can decode pretty-printed multi-line base64 data as well as long, single-line base64 data. Textabulous!

<span class="primary">Base64 to text decoder examples</span> <span class="secondary">Click to use</span>

Decode Text from Base64

In this example, we convert base64 data back to comprehensible text that you can read.

WW91IGNhbiBlYXNpbHkgcmVwcmVzZW50IGFuZCB0cmFuc2ZlciBiaW5hcnkgZmlsZXMgYXMgdGV4dCwgaWYgeW91IGVuY29kZSB0aGVtIHRvIGJhc2U2NC4=

You can easily represent and transfer binary files as text, if you encode them to base64.

Multi-line Base64

This example takes six lines of base64 data as input and treats them as a single line. Internally it skips newline symbols and it easily decodes the given data.

QnJldm l0eSBp cyB0aG Ugc291 bCBvZi B3aXQu
...
<span class="muted"><span class="green">https://</span>onlinetexttools.com/convert-base64-to-text</span><span class="underline">?input</span>=WW91IGNhbiBlYXNpbHkgcmVwcmVzZW50IGFuZCB0cmFuc2ZlciBiaW5hcnkgZmlsZXMgYXMgdGV4dCwgaWYgeW91IGVuY29kZSB0aGVtIHRvIGJhc2U2NC4%3D
