binary-xor by HTTrack Website Copier/3.x \[XR&CO"2014\], Mon, 14 Dec 2020 03:29:29 GMT --&gt;
...
World"s simplest bitwise XOR calculator. Just paste your binary numbers in the form below, press Compute Binary XOR button, and you get binary bitwise XOR of all the binary values. Press button, XOR binary. No ads, nonsense or garbage.
...
<span id="copy-to-clipboard">[![](../images/copy-to-clipboard.png "Copy to clipboard")](#)</span> <span id="binary-xor-submit-undo" class="undo">[(undo)](#)</span>
...
Want to NOT binary numbers?

Use the [Binary NOT Calculator](binary-not)!

Want to XNOR binary numbers?

Use the [Binary NXOR Calculator](binary-xnor)!
