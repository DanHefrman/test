seconds-to-hms by HTTrack Website Copier/3.x \[XR&CO'2014\], Mon, 14 Dec 2020 03:25:48 GMT --&gt;
...
World's simplest seconds to HH:MM:SS converter. Just paste your seconds in the form below, press Convert button, and you get H:M:S. Press button, get HMS. No ads, nonsense or garbage.
...
<span id="copy-to-clipboard">[![](../images/copy-to-clipboard.png "Copy to clipboard")](#)</span> <span id="seconds-to-hms-submit-undo" class="undo">[(undo)](#)</span>

Want to convert h:m:s to secs instead?

Use the [HMS to Seconds tool](hms-to-seconds)!
