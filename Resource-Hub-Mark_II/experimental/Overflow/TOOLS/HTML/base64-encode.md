base64-encode by HTTrack Website Copier/3.x \[XR&CO"2014\], Mon, 14 Dec 2020 03:24:54 GMT --&gt;
...
World"s simplest base64 encoder. Just paste your data in the form below, press Base64 Encode button, and you get base64 encoded data. Press button, get base64. Works with UTF8 strings. No ads, nonsense or garbage.
...
<span id="copy-to-clipboard">[![](../images/copy-to-clipboard.png "Copy to clipboard")](#)</span> <span id="base64-encode-submit-undo" class="undo">[(undo)](#)</span>

Want to base64 decode?

Use the [base64 decoder tool](base64-decode)!
