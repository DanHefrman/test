url-encode by HTTrack Website Copier/3.x \[XR&CO'2014\], Mon, 14 Dec 2020 03:24:51 GMT --&gt;
...
World's simplest URL encoder. Just paste your URL in the form below, press URL Encode button, and you get escaped URL. Press button, get URL. No ads, nonsense or garbage.
...
<span id="copy-to-clipboard">[![](../images/copy-to-clipboard.png "Copy to clipboard")](#)</span> <span id="url-encode-submit-undo" class="undo">[(undo)](#)</span>

Want to decode a URL?

Use the [URL decoder tool](url-decode)!
