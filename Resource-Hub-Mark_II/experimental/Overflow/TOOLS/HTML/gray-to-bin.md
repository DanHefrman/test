gray-to-bin by HTTrack Website Copier/3.x \[XR&CO"2014\], Mon, 14 Dec 2020 03:29:24 GMT --&gt;
...
World"s simplest Gray code calculator. Just paste your Gray code in the form below, press Convert button, and you get a binary. Press button, get binary. No ads, nonsense or garbage.
...
<span id="copy-to-clipboard">[![](../images/copy-to-clipboard.png "Copy to clipboard")](#)</span> <span id="gray-to-bin-submit-undo" class="undo">[(undo)](#)</span>

Want to convert binary to Gray code?

Use the [Binary to Gray code converter](bin-to-gray)!
