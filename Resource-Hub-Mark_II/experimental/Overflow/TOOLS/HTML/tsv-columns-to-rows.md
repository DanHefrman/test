tsv-columns-to-rows by HTTrack Website Copier/3.x \[XR&CO'2014\], Mon, 14 Dec 2020 03:25:32 GMT --&gt;
...
Convert Columns to Rows in TSV Files
====================================

web developer and programmer tools
----------------------------------

World's simplest TSV column and row exchanger. Just paste your TSV in the form below, press Convert TSV button, and columns become rows. Press button, invert TSV. No ads, nonsense or garbage.
...
<span id="copy-to-clipboard">[![](../images/copy-to-clipboard.png "Copy to clipboard")](#)</span> <span id="tsv-columns-to-rows-submit-undo" class="undo">[(undo)](#)</span>

Want to extract TSV columns?

Use the [TSV Column Extractor](tsv-extract-column) tool!

Want to swap TSV column order?

Use the [Swap TSV Columns](tsv-swap-columns) tool!

Want to convert TSV rows to columns?

Use the [Convert TSV Rows to Columns](tsv-rows-to-columns) tool!
