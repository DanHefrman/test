line-count by HTTrack Website Copier/3.x \[XR&CO'2014\], Mon, 14 Dec 2020 03:28:54 GMT --&gt;
...
World's simplest text line counter. Just paste your text in the form below, press Find Number of Lines button, and you get the number of lines in your text. Press button, get line count. No ads, nonsense or garbage.

**Announcement**: We just launched [math tools for developers](../../www.onlinemathtools.com/index68b6.html?msg2). Check it out!

<span id="copy-to-clipboard">[![](../images/copy-to-clipboard.png "Copy to clipboard")](#)</span> <span id="line-count-submit-undo" class="undo">[(undo)](#)</span>
