...
World"s simplest browser-based utility for adding suffixes to text. Load your text in the input form on the left and you"ll instantly get suffixed text in the output area. Powerful, free, and fast. Load plain text – get suffixed text. Created by developers from team broowserools.
...
<span class="data-type">suffixed text</span> <span class="status"></span>
...
Text suffixer options

<span class="option-group-legend">Suffix Data</span>

Suffix text <span class="option-details">Use this content as a suffix.</span>

<span class="option-group-legend">Text Suffix Mode</span>

Line-by-line Mode <span class="option-details">Append suffix at the end of each line.</span>

Single Suffix Mode <span class="option-details">Append suffix only once at the end of the text.</span>

Paragraph Mode <span class="option-details">Append suffix after every paragraph.</span>

<span class="option-group-legend">Blank Lines</span>

Skip Blank Lines <span class="option-details">Leave blank lines empty.</span>

<span class="option-details">Applicable only to active line-by-line mode.</span>

<span class="primary">Text suffixer tool</span> <span class="secondary">What is a text suffixer?</span>

With this tool you can append a postfix data to the end of text. The data to be appended can be anything – numbers, sentences or just chracters. There are multiple ways you can add a suffix. The first is line-by-line option. This option adds a postfix to your input text on every line (unless you select skip blank lines function). The second option appends a postifx just once at the very end of text, and the third option postfixes text only at the end of each paragraph. Textabulous!

<span class="primary">Text suffixer examples</span> <span class="secondary">Click to use</span>

Postfix a List of Juices

In this example, we"ve enabled line-by-line postfix mode and we add the word "juice" at the end of each list item. As a result we"ve quickly constructed a new list of juice varieties.

orange apple carrot pineapple tomato grape cherry

orange juice apple juice carrot juice pineapple juice tomato juice grape juice cherry juice
...
This example adds a suffix to a quote from The Notebook book. We use the name of author and title as a suffix and apply it only once at the end of text.
...
<span class="muted"><span class="green">https://</span>onlinetexttools.com/add-text-suffix</span><span class="underline">?input</span>=orange%0Aapple%0Acarrot%0Apineapple%0Atomato%0Agrape%0Acherry&multi-line-mode=true&suffix=%20juice
