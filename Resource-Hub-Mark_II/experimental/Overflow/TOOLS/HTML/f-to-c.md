f-to-c by HTTrack Website Copier/3.x \[XR&CO"2014\], Mon, 14 Dec 2020 03:29:35 GMT --&gt;
...
World"s simplest Fahrenheit to Celsius calculator. Just enter your Fahrenheit temperature in the form below, press Convert button, and you get Celsius scale temperature. Press button, get Celsius. No ads, nonsense or garbage.
...
<span id="copy-to-clipboard">[![](../images/copy-to-clipboard.png "Copy to clipboard")](#)</span> <span id="f-to-c-submit-undo" class="undo">[(undo)](#)</span>

Want to convert Celsius to Fahrenheit?

Use the [Celsius to Fahrenheit converter](c-to-f)!
