des-decrypt by HTTrack Website Copier/3.x \[XR&CO"2014\], Mon, 14 Dec 2020 03:26:24 GMT --&gt;
...
World"s simplest DES decryptor. Just paste your text in the form below, enter password, press DES Decrypt button, and you get decrypted message. Press button, get text. No ads, nonsense or garbage.
...
<span id="copy-to-clipboard">[![](../images/copy-to-clipboard.png "Copy to clipboard")](#)</span> <span id="des-decrypt-submit-undo" class="undo">[(undo)](#)</span>

Want to DES-encrypt text?

Use the [DES-encrypt tool](des-encrypt)!
