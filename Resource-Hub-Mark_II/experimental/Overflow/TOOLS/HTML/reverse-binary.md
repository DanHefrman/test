reverse-binary by HTTrack Website Copier/3.x \[XR&CO'2014\], Mon, 14 Dec 2020 03:29:30 GMT --&gt;
...
Binary String Reverser
======================

web developer and programmer tools
----------------------------------

World's simplest binary bits reverser. Just paste your binary numbers in the form below, press Reverse Bits, and you get reversed binary strings. Press button, reverse binary. No ads, nonsense or garbage.
...
<span id="copy-to-clipboard">[![](../images/copy-to-clipboard.png "Copy to clipboard")](#)</span> <span id="reverse-binary-submit-undo" class="undo">[(undo)](#)</span>

Want to invert binary numbers?

Use the [Binary Inverter](invert-binary) tool!

Want to rotate binary numbers?

Use the [Binary Rotator](rotate-binary) tool!
