url-parse by HTTrack Website Copier/3.x \[XR&CO'2014\], Mon, 14 Dec 2020 03:24:53 GMT --&gt;
...
URL Compontent Parser
=====================

web developer and programmer tools
----------------------------------

World's simplest URL parser. Just paste your link in the form below, press URL Parse button, and you get it split into components. Press button, get components. No ads, nonsense or garbage.
...
<span id="copy-to-clipboard">[![](../images/copy-to-clipboard.png "Copy to clipboard")](#)</span> <span id="url-parse-submit-undo" class="undo">[(undo)](#)</span>
