suffix-lines by HTTrack Website Copier/3.x \[XR&CO'2014\], Mon, 14 Dec 2020 03:29:00 GMT --&gt;
...
World's simplest text line suffixer. Just paste your text in the form below, press Suffix Lines button, and you get suffixed strings. Press button, get suffixes. No ads, nonsense or garbage.
...
<span id="copy-to-clipboard">[![](../images/copy-to-clipboard.png "Copy to clipboard")](#)</span> <span id="suffix-lines-submit-undo" class="undo">[(undo)](#)</span>

Want to add prefix to lines?

Use the [Prefix text lines tool](prefix-lines)!
