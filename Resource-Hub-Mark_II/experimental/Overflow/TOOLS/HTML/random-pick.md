random-pick by HTTrack Website Copier/3.x \[XR&CO'2014\], Mon, 14 Dec 2020 03:29:18 GMT --&gt;
...
World's simplest random element selector. Just paste your choices in the form below, press Select a Random Element button, and you get a random item. Press button, get item. No ads, nonsense or garbage. Works with names, numbers and words.
...
<span id="copy-to-clipboard">[![](../images/copy-to-clipboard.png "Copy to clipboard")](#)</span> <span id="random-pick-submit-undo" class="undo">[(undo)](#)</span>

Need to generate random numbers?

Use [Random Number Generator](random-numbers) tool!
