merge-lists by HTTrack Website Copier/3.x \[XR&CO'2014\], Mon, 14 Dec 2020 03:29:08 GMT --&gt;
...
Combine Two Lists Line by Line
==============================

web developer and programmer tools
----------------------------------

World's simplest list merger. Just paste your lists in the forms below, press Concatenate Lists button, and you get a merged list. Press button, get list. No ads, nonsense or garbage.
...
<span id="copy-to-clipboard">[![](../images/copy-to-clipboard.png "Copy to clipboard")](#)</span> <span id="merge-lists-submit-undo" class="undo">[(undo)](#)</span>

Pro tip: To merge three lists or more, just merge the output with a new list.

Need to sort lists before merging?

Use the [Sort Text Lists](text-sort) tool!
