invert-binary by HTTrack Website Copier/3.x \[XR&CO"2014\], Mon, 14 Dec 2020 03:29:30 GMT --&gt;
...
Binary String Inverter
======================

web developer and programmer tools
----------------------------------

World"s simplest bitwise bit inverter. Just paste your binary numbers in the form below, press Invert Bits, and you get an inverted binary string. Press button, flip binary. No ads, nonsense or garbage.
...
<span id="copy-to-clipboard">[![](../images/copy-to-clipboard.png "Copy to clipboard")](#)</span> <span id="invert-binary-submit-undo" class="undo">[(undo)](#)</span>

Want to reverse binary numbers?

Use the [Binary Reverser](reverse-binary)!
