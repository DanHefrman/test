text-columns-to-rows by HTTrack Website Copier/3.x \[XR&CO'2014\], Mon, 14 Dec 2020 03:25:40 GMT --&gt;
...
Convert Columns to Rows in Text Files
=====================================

web developer and programmer tools
----------------------------------

World's simplest text data column to row transformer. Just paste your data in the form below, press Convert button, and columns get converted to rows. Press button, invert text data. No ads, nonsense or garbage.
...
<span id="copy-to-clipboard">[![](../images/copy-to-clipboard.png "Copy to clipboard")](#)</span> <span id="text-columns-to-rows-submit-undo" class="undo">[(undo)](#)</span>
...
Want to convert text rows to columns?

Use the [Convert Rows to Columns](text-rows-to-columns) tool!
