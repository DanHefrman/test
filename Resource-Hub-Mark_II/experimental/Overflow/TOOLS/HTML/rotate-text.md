...
World's simplest browser-based utility for cyclically rotating text. Load your text in the input form on the left and you'll instantly get text with rotated characters in the output area. Powerful, free, and fast. Load text – get rotated text. Created by developers from team broowserools.
...
<span class="data-type">rotated text</span> <span class="status"></span>
...
Text rotator options

<span class="option-group-legend">Rotation Direction</span>

Left-Side Rotation <span class="option-details">Shift text to the left side.</span>

Right-Side Rotation <span class="option-details">Shift text to the right side.</span>

Rotation Count <span class="option-details">Number of characters you want to rotate.</span>

<span class="option-group-legend">Multiline Rotation Mode</span>

Line-by-Line Rotation <span class="option-details">If your text contains several lines, each line will rotate individually.</span>

<span class="primary">Text rotator tool</span> <span class="secondary">What is a text rotator?</span>

With this tool, you can rotate letters in the given text to the left or right. If you choose the left direction, then the whole text will be shifted to the left by the number of characters you specify. In this case, letters that were in front of the text will appear at the end. If you choose the right direction, then the opposite happens. The text will move to the right side, and letters from the end will transfer to the front. The number of characters to move on the other side can be specified in the settings. If your text contains several lines, then by activating line-by-line mode, each line will rotate individually. Textabulous!

<span class="primary">Text rotator examples</span> <span class="secondary">Click to use</span>

Left-Side Rotation

In this example, we rotate a short text about a fox to the left side by 12 positions. The first 12 characters, with the content: "the fox was ", are shifted from the beginning of the text to the end of the text.

the fox was faster than the wind

faster than the wind the fox was
...
This example takes the last two characters at the end of the text and places them at the beginning of the text, thus rotating the entire text to the right by two units.

You are about 1 centimeter taller in the morning than in the evening!

g!You are about 1 centimeter taller in the morning than in the evenin
...
Multiline Text Rotation

In this example, we've got several text lines and we activate the line-by-line rotation mode. We shift each text line by five letters to the left, and we get the word "Hello" placed at the end of each sentence.

Hello my friend! Hello my baby! Hello my darling! Hello my honey! Hello my pal!

my friend!Hello my baby!Hello my darling!Hello my honey!Hello my pal!Hello
...
<span class="muted"><span class="green">https://</span>onlinetexttools.com/rotate-text</span><span class="underline">?input</span>=the%20fox%20was%20faster%20than%20the%20wind%20&rotate-left=true&count=12
