scrypt-check by HTTrack Website Copier/3.x \[XR&CO'2014\], Mon, 14 Dec 2020 03:28:29 GMT --&gt;
...
Check Scrypt Password Hash
==========================

web developer and programmer tools
----------------------------------

World's simplest online scrypt hash checker. Just paste your hash in the form below, enter password and salt, press Test Scrypt Hash button, and your hash gets verified. Press button, check hash. No ads, nonsense or garbage.
...
N is CPU difficulty (power of two), r is memory difficulty, p is parallelization difficulty.

<span id="copy-to-clipboard">[![](../images/copy-to-clipboard.png "Copy to clipboard")](#)</span> <span id="scrypt-check-submit-undo" class="undo">[(undo)](#)</span>

Want to generate a scrypt hash?

Use the [Scrypt Hash Generator](scrypt) tool!
