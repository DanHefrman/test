yaml-to-tsv by HTTrack Website Copier/3.x \[XR&CO'2014\], Mon, 14 Dec 2020 03:25:18 GMT --&gt;
...
World's simplest YAML to TSV converter. Just paste your YAML in the form below, press Convert button, and you get tab separated values. Press button, get TSV. No ads, nonsense or garbage.
...
<span id="copy-to-clipboard">[![](../images/copy-to-clipboard.png "Copy to clipboard")](#)</span> <span id="yaml-to-tsv-submit-undo" class="undo">[(undo)](#)</span>

Want to convert TSV to YAML instead?

Use the [TSV to YAML converter tool](tsv-to-yaml)!
