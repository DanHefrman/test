reverse-lines by HTTrack Website Copier/3.x \[XR&CO'2014\], Mon, 14 Dec 2020 03:29:03 GMT --&gt;
...
World's simplest line order reverser. Just paste your text in the form below, press Reverse Lines button, and you get reversed lines. Press button, get reversed text lines. No ads, nonsense or garbage.
...
<span id="copy-to-clipboard">[![](../images/copy-to-clipboard.png "Copy to clipboard")](#)</span> <span id="reverse-lines-submit-undo" class="undo">[(undo)](#)</span>

Want to reverse character order?

Use the [Text Reverse tool](text-reverse)!
