phrase-frequency by HTTrack Website Copier/3.x \[XR&CO'2014\], Mon, 14 Dec 2020 03:28:59 GMT --&gt;
...
World's simplest phrase frequency calculator. Just paste your text in the form below, press Calculate Phrase Count button, and you get phrase statistics. Press button, get phrase count. No ads, nonsense or garbage.
...
<span id="copy-to-clipboard">[![](../images/copy-to-clipboard.png "Copy to clipboard")](#)</span> <span id="phrase-frequency-submit-undo" class="undo">[(undo)](#)</span>

Want to find word frequency in text?

Use the [Word frequency calculator](word-frequency)!
