text-randomcase by HTTrack Website Copier/3.x \[XR&CO'2014\], Mon, 14 Dec 2020 03:25:57 GMT --&gt;
...
World's simplest text to randomcase converter. Just paste text in the form below, press Randomize Case button, and you get random case letters. Press button, get text. No ads, nonsense or garbage. Works with Unicode and UTF8 as well.
...
<span id="copy-to-clipboard">[![](../images/copy-to-clipboard.png "Copy to clipboard")](#)</span> <span id="text-randomcase-submit-undo" class="undo">[(undo)](#)</span>

Need to convert text to lowercase or uppercase?

Use [Text to Lowercase Converter](text-lowercase),

or [Text to Uppercase Converter](text-uppercase)!
