unix-to-utc by HTTrack Website Copier/3.x \[XR&CO'2014\], Mon, 14 Dec 2020 03:25:42 GMT --&gt;
...
World's simplest UNIX timestamp to UTC time converter. Just paste the POSIX Epoch in the form below, press Convert button, and you get UTC time. Press button, get time. No ads, nonsense or garbage.
...
<span id="copy-to-clipboard">[![](../images/copy-to-clipboard.png "Copy to clipboard")](#)</span> <span id="unix-to-utc-submit-undo" class="undo">[(undo)](#)</span>

Want to convert UTC time to UNIX time instead?

Use the [UTC time to UNIX time converter tool](utc-to-unix)!
