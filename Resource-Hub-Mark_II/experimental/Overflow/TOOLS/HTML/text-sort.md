text-sort by HTTrack Website Copier/3.x \[XR&CO'2014\], Mon, 14 Dec 2020 03:28:55 GMT --&gt;
...
World's simplest text sorter. Just paste your text in the form below, press Sort Text button, and you get sorted text. Press button, get text. No ads, nonsense or garbage.
...
<span id="copy-to-clipboard">[![](../images/copy-to-clipboard.png "Copy to clipboard")](#)</span> <span id="text-sort-submit-undo" class="undo">[(undo)](#)</span>

Want to sort in numeric order?

Use the [number sort](numeric-sort) tool!
