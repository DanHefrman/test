ascii85-encode by HTTrack Website Copier/3.x \[XR&CO"2014\], Mon, 14 Dec 2020 03:25:59 GMT --&gt;
...
World"s simplest ascii85 encoder. Just paste your data in the form below, press Ascii85 Encode button, and you get base85 encoded data. Press button, get ascii85. No ads, nonsense or garbage.
...
<span id="copy-to-clipboard">[![](../images/copy-to-clipboard.png "Copy to clipboard")](#)</span> <span id="ascii85-encode-submit-undo" class="undo">[(undo)](#)</span>

Want to Ascii85 decode?

Use the [Ascii85 decoder tool](ascii85-decode)!
