xml-prettify by HTTrack Website Copier/3.x \[XR&CO'2014\], Mon, 14 Dec 2020 03:25:03 GMT --&gt;
...
World's simplest XML beautifier. Just paste your XML in the form below, press XML Prettify button, and you get beautiful and clean XML. Press button, get XML. No ads, nonsense or garbage.
...
<span id="copy-to-clipboard">[![](../images/copy-to-clipboard.png "Copy to clipboard")](#)</span> <span id="xml-prettify-submit-undo" class="undo">[(undo)](#)</span>

Want to prettify XML?

Use the [XML minifier tool](xml-minify)!
