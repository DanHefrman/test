csv-insert-column by HTTrack Website Copier/3.x \[XR&CO"2014\], Mon, 14 Dec 2020 03:25:29 GMT --&gt;
...
Insert a CSV Column in Existing CSV
===================================

web developer and programmer tools
----------------------------------

World"s simplest online CSV column inserter. Just paste your CSV and the new column in the forms below, press Insert CSV Column button, and you the new column gets inserted at the given position. Press button, insert column. No ads, nonsense or garbage.
...
<span id="copy-to-clipboard">[![](../images/copy-to-clipboard.png "Copy to clipboard")](#)</span> <span id="csv-insert-column-submit-undo" class="undo">[(undo)](#)</span>
