...
World"s simplest browser-based utility for encoding text to base64. Load your text in the input form on the left and you"ll instantly get base64 in the output area. Powerful, free, and fast. Load text – get base64. Created by developers from team broowserools.
...
<span class="data-type">base64</span> <span class="status"></span>
...
Text to base64 converter options

<span class="option-group-legend">Number of Characters per Line</span>

Write Base64 in Several Lines <span class="option-details">Split base64 into multiple lines.</span>

Line length <span class="option-details">Characters per each line.</span>

Write Base64 in One Piece <span class="option-details">Output base64 as a single line.</span>

<span class="primary">Text to base64 converter tool</span> <span class="secondary">What is a text to base64 converter?</span>

With this tool you can convert text to base64 encoding. This encoding converts every three bytes of text into four bytes from a set of 64 character alphabet. As the encoded data runs long, then for your convenience we"ve added an option that divides the data into pieces by specifying the number of characters per line. Textabulous!

<span class="primary">Text to base64 converter examples</span> <span class="secondary">Click to use</span>

Gone with the Wind Quote

In this example we encode a phrase from the movie "Gone with the Wind" to base64.

After all, tomorrow is another day!

QWZ0ZXIgYWxsLCB0b21vcnJvdyBpcyBhbm90aGVyIGRheSE=
...
This example converts text about the galaxy to base64. At the same time it splits the result into parts that consist of 25 characters.

A galaxy is a giant cosmic cluster of stars, gas, dust, nebulae and black holes held by the forces of gravity. All objects that make up the galaxy revolve around a common center of mass. Most often it is a giant core, which is located in the center, consisting of a black hole. There are probably more than 170 billion galaxies in the observable universe. Their sizes can differ significantly, from dwarfs with as few as ten million stars to giants with a one hundred trillion or more stars.

QSBnYWxheHkgaXMgYSBnaWFud CBjb3NtaWMgY2x1c3RlciBvZi BzdGFycywgZ2FzLCBkdXN0LCB uZWJ1bGFlIGFuZCBibGFjayBo b2xlcyBoZWxkIGJ5IHRoZSBmb 3JjZXMgb2YgZ3Jhdml0eS4gQW xsIG9iamVjdHMgdGhhdCBtYWt lIHVwIHRoZSBnYWxheHkgcmV2 b2x2ZSBhcm91bmQgYSBjb21tb 24gY2VudGVyIG9mIG1hc3MuIE 1vc3Qgb2Z0ZW4gaXQgaXMgYSB naWFudCBjb3JlLCB3aGljaCBp cyBsb2NhdGVkIGluIHRoZSBjZ W50ZXIsIGNvbnNpc3Rpbmcgb2 YgYSBibGFjayBob2xlLiBUaGV yZSBhcmUgcHJvYmFibHkgbW9y ZSB0aGFuIDE3MCBiaWxsaW9uI GdhbGF4aWVzIGluIHRoZSBvYn NlcnZhYmxlIHVuaXZlcnNlLiB UaGVpciBzaXplcyBjYW4gZGlm ZmVyIHNpZ25pZmljYW50bHksI GZyb20gZHdhcmZzIHdpdGggYX MgZmV3IGFzIHRlbiBtaWxsaW9 uIHN0YXJzIHRvIGdpYW50cyB3 aXRoIGEgb25lIGh1bmRyZWQgd HJpbGxpb24gb3IgbW9yZSBzdG Fycy4=
...
<span class="muted"><span class="green">https://</span>onlinetexttools.com/convert-text-to-base64</span><span class="underline">?input</span>=After%20all%2C%20tomorrow%20is%20another%20day%21&base64-no-split=true
