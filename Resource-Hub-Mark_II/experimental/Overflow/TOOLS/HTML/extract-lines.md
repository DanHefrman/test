extract-lines by HTTrack Website Copier/3.x \[XR&CO"2014\], Mon, 14 Dec 2020 03:29:11 GMT --&gt;
...
Extract Lines x to y From a Text File
=====================================

web developer and programmer tools
----------------------------------

World"s simplest line extractor. Just paste your text in the form below, press Get Line Range button, and you get a line interval. Press button, get range. No ads, nonsense or garbage.
...
<span id="copy-to-clipboard">[![](../images/copy-to-clipboard.png "Copy to clipboard")](#)</span> <span id="extract-lines-submit-undo" class="undo">[(undo)](#)</span>

From line: To line:

Want to find first n lines of text?

Use the [Head Text Lines](head) tool!

Want to find last n lines of text?

Use the [Tail Text Lines](tail) tool!
