...
World's simplest browser-based utility for JSON stringifying text. Load your text in the input form on the left and you'll instantly get JSON-escaped text in the output area. Powerful, free, and fast. Load text – get stringified text. Created by developers from team broowserools.
...
<span class="data-type">stringified text</span> <span class="status"></span>
...
<span class="primary">Text stringifier tool</span> <span class="secondary">What is a text stringifier?</span>

With this tool you can JSON stringify the given text. The tool calls the stringify() function on your input and you get JSON-escaped text as output. Reserved JSON characters, such as backspaces, form feeds, newlines, carriage returns, tabs, double quotes and backslashes are escaped with an extra backslash. Textabulous!

<span class="primary">Text stringifier examples</span> <span class="secondary">Click to use</span>

Quote Text

This example loads a song from the Disney animated film The Lion King and stringifies it to a JSON string. As you can see, newlines get turned into \\n symbols, tabs get turned into \\t symbols and the whole text gets wrapped in a pair of quotes.

Hakuna Matata! What a wonderful phrase Hakuna Matata! Ain't no passing craze Yeah. It's our motto! What's a motto? "Hakuna Matata!"
...
var personal\_data = { "name" : "Robert", "age" : "30" , "country" : "USA", "interests" : "JSON" }
...
<span class="muted"><span class="green">https://</span>onlinetexttools.com/json-stringify-text</span><span class="underline">?input</span>=Hakuna%20Matata%21%0AWhat%20a%20wonderful%20phrase%0AHakuna%20Matata%21%0AAin%27t%20no%20passing%20craze%0AYeah.%20It%27s%20our%20motto%21%0AWhat%27s%20a%20motto%3F%0A%09%22Hakuna%20Matata%21%22
