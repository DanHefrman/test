js-validate by HTTrack Website Copier/3.x \[XR&CO'2014\], Mon, 14 Dec 2020 03:25:01 GMT --&gt;
...
World's simplest JavaScript validator. Just paste your JavaScript in the form below, press JS Validate button, and your JavaScript gets validated. Press button, validate JavaScript. No ads, nonsense or garbage.
...
<span id="copy-to-clipboard">[![](../images/copy-to-clipboard.png "Copy to clipboard")](#)</span> <span id="js-validate-submit-undo" class="undo">[(undo)](#)</span>

Want to beautify JavaScript?

Use the [JavaScript Beautifier](js-prettify) tool!
