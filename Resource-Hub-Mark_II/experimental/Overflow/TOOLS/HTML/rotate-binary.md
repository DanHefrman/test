rotate-binary by HTTrack Website Copier/3.x \[XR&CO'2014\], Mon, 14 Dec 2020 03:29:30 GMT --&gt;
...
Circularly Rotate Binary Bits
=============================

web developer and programmer tools
----------------------------------

World's simplest circular binary number rotator. Just paste your binary numbers in the form below, press Circular Bitwise Rotate, and you get all numbers circularly rotated bit by bit. Press button, rotate bits. No ads, nonsense or garbage.
...
Bit rotation direction: Left Right

<span id="copy-to-clipboard">[![](../images/copy-to-clipboard.png "Copy to clipboard")](#)</span> <span id="rotate-binary-submit-undo" class="undo">[(undo)](#)</span>

Want to reverse binary numbers?

Use the [Reverse Binary Numbers](reverse-binary) tool!
