csv-to-text by HTTrack Website Copier/3.x \[XR&CO"2014\], Mon, 14 Dec 2020 03:25:26 GMT --&gt;
...
World"s simplest CSV to text converter. Just paste your comma separated values in the form below, press Convert CSV to Text button, and you get text columns. Press button, get columns. No ads, nonsense or garbage.
...
<span id="copy-to-clipboard">[![](../images/copy-to-clipboard.png "Copy to clipboard")](#)</span> <span id="csv-to-text-submit-undo" class="undo">[(undo)](#)</span>

Want to convert text columns to CSV instead?

Use the [Text to CSV converter tool](text-to-csv)!
