json-escape by HTTrack Website Copier/3.x \[XR&CO'2014\], Mon, 14 Dec 2020 03:24:58 GMT --&gt;
...
World's simplest JSON escaper. Just paste your JSON in the form below, press JSON Escape button, and you get escaped JSON. Press button, escape JSON. No ads, nonsense or garbage.
...
<span id="copy-to-clipboard">[![](../images/copy-to-clipboard.png "Copy to clipboard")](#)</span> <span id="json-escape-submit-undo" class="undo">[(undo)](#)</span>

Want to unescape JSON?

Use the [JSON Unescaper tool](json-unescape)!

Want to prettify JSON?

Use the [JSON Prettifier tool](json-prettify)!
