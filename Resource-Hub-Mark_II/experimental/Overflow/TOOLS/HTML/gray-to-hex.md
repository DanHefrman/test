gray-to-hex by HTTrack Website Copier/3.x \[XR&CO"2014\], Mon, 14 Dec 2020 03:29:26 GMT --&gt;
...
World"s simplest Gray code calculator. Just paste your Gray code in the form below, press Convert button, and you get a hexadecimal. Press button, get hex. No ads, nonsense or garbage.
...
<span id="copy-to-clipboard">[![](../images/copy-to-clipboard.png "Copy to clipboard")](#)</span> <span id="gray-to-hex-submit-undo" class="undo">[(undo)](#)</span>

Want to convert hexadecimal to Gray code?

Use the [Hex to Gray code converter](hex-to-gray)!
