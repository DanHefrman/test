numeric-sort by HTTrack Website Copier/3.x \[XR&CO'2014\], Mon, 14 Dec 2020 03:28:55 GMT --&gt;
...
World's simplest numeric sort. Just paste your numbers in the form below, press Sort Numbers button, and you get sorted numbers. Press button, get numbers. No ads, nonsense or garbage.
...
<span id="copy-to-clipboard">[![](../images/copy-to-clipboard.png "Copy to clipboard")](#)</span> <span id="numeric-sort-submit-undo" class="undo">[(undo)](#)</span>

Want to sort in alphabetic order?

Use the [alphabetic sort](text-sort) tool!
