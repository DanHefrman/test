csv-transpose by HTTrack Website Copier/3.x \[XR&CO"2014\], Mon, 14 Dec 2020 03:25:26 GMT --&gt;
...
World"s simplest CSV transposer. Just paste your CSV in the form below, press Transpose CSV button, and you get your comma separated values transposed. Press button, transpose CSV. No ads, nonsense or garbage.
...
<span id="copy-to-clipboard">[![](../images/copy-to-clipboard.png "Copy to clipboard")](#)</span> <span id="csv-transpose-submit-undo" class="undo">[(undo)](#)</span>
