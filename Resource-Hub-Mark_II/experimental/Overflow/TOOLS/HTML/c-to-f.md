...
World"s simplest Celsius to Fahrenheit calculator. Just enter your Celsius temperature in the form below, press Convert button, and you get Fahrenheit scale temperature. Press button, get Fahrenheits. No ads, nonsense or garbage.
...
<span id="copy-to-clipboard">[![](../images/copy-to-clipboard.png "Copy to clipboard")](#)</span> <span id="c-to-f-submit-undo" class="undo">[(undo)](#)</span>

Want to convert Fahrenheit to Celsius?

Use the [Fahrenheit to Celsius converter](f-to-c)!
