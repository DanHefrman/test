hex-to-bcd by HTTrack Website Copier/3.x \[XR&CO"2014\], Mon, 14 Dec 2020 03:29:23 GMT --&gt;
...
World"s simplest hex BCD encoder. Just paste your hexadecimal numbers in the form below, press Convert button, and you get binary coded decimals. Press button, get BCD. No ads, nonsense or garbage.
...
<span id="copy-to-clipboard">[![](../images/copy-to-clipboard.png "Copy to clipboard")](#)</span> <span id="hex-to-bcd-submit-undo" class="undo">[(undo)](#)</span>

Want to convert BCD to hex?

Use the [BCD to Hex converter](bcd-to-hex)!
