punycode-encode by HTTrack Website Copier/3.x \[XR&CO'2014\], Mon, 14 Dec 2020 03:26:02 GMT --&gt;
...
World's simplest punyencoder. Just paste your string or text in the form below, press Punyencode button, and you get puny-encoded data. Press button, get punycode. No ads, nonsense or garbage. Works with UTF8 and Unicode.
...
<span id="copy-to-clipboard">[![](../images/copy-to-clipboard.png "Copy to clipboard")](#)</span> <span id="punycode-encode-submit-undo" class="undo">[(undo)](#)</span>

Want to Punydecode?

Use the [Puny decoder tool](punycode-decode)!
