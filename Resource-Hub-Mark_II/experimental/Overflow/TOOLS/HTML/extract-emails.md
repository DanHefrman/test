extract-emails by HTTrack Website Copier/3.x \[XR&CO"2014\], Mon, 14 Dec 2020 03:29:04 GMT --&gt;
...
World"s simplest email extractor. Just paste your text in the form below, press Extract Emails button, and you get a list of emails. Press button, extract emails. No ads, nonsense or garbage.
...
<span id="copy-to-clipboard">[![](../images/copy-to-clipboard.png "Copy to clipboard")](#)</span> <span id="extract-emails-submit-undo" class="undo">[(undo)](#)</span>

Want to generate random emails?

Use the [regular expression data generator](text-from-regex) tool!
