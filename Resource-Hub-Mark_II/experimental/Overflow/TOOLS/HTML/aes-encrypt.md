aes-encrypt by HTTrack Website Copier/3.x \[XR&CO"2014\], Mon, 14 Dec 2020 03:26:18 GMT --&gt;
...
World"s simplest AES encryptor. Just paste your text in the form below, enter password, press AES Encrypt button, and you get encrypted text. Press button, get AES. No ads, nonsense or garbage.
...
<span id="copy-to-clipboard">[![](../images/copy-to-clipboard.png "Copy to clipboard")](#)</span> <span id="aes-encrypt-submit-undo" class="undo">[(undo)](#)</span>

Want to AES-decrypt text?

Use the [AES-decrypt tool](aes-decrypt)!
