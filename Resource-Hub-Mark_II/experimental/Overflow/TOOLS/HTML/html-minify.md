html-minify by HTTrack Website Copier/3.x \[XR&CO"2014\], Mon, 14 Dec 2020 03:24:56 GMT --&gt;
...
World"s simplest HTML minifier. Just paste your HTML in the form below, press HTML Minify button, and you get compressed HTML. Press button, get HTML. No ads, nonsense or garbage.

**Announcement**: We just launched [math tools for developers](../../www.onlinemathtools.com/index68b6.html?msg2). Check it out!

<span id="copy-to-clipboard">[![](../images/copy-to-clipboard.png "Copy to clipboard")](#)</span> <span id="html-minify-submit-undo" class="undo">[(undo)](#)</span>

Want to prettify HTML?

Use the [HTML prettifier tool](html-prettify)!
