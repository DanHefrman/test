bcd-to-oct by HTTrack Website Copier/3.x \[XR&CO"2014\], Mon, 14 Dec 2020 03:29:23 GMT --&gt;
...
World"s simplest oct BCD calculator. Just paste your BCDs in the form below, press Convert button, and you get octals. Press button, get oct. No ads, nonsense or garbage.
...
<span id="copy-to-clipboard">[![](../images/copy-to-clipboard.png "Copy to clipboard")](#)</span> <span id="bcd-to-oct-submit-undo" class="undo">[(undo)](#)</span>

Want to convert oct to BCD?

Use the [Oct to BCD converter](oct-to-bcd)!
