oct-to-bcd by HTTrack Website Copier/3.x \[XR&CO'2014\], Mon, 14 Dec 2020 03:29:23 GMT --&gt;
...
World's simplest oct BCD encoder. Just paste your octals in the form below, press Convert button, and you get binary coded decimals. Press button, get BCD. No ads, nonsense or garbage.
...
<span id="copy-to-clipboard">[![](../images/copy-to-clipboard.png "Copy to clipboard")](#)</span> <span id="oct-to-bcd-submit-undo" class="undo">[(undo)](#)</span>

Want to convert BCD to oct?

Use the [BCD to Oct converter](bcd-to-oct)!
