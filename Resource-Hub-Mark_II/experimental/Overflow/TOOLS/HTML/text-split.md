text-split by HTTrack Website Copier/3.x \[XR&CO'2014\], Mon, 14 Dec 2020 03:29:02 GMT --&gt;
...
World's simplest string splitter. Just paste your text in the form below, press Split Text button, and you get text split into columns by given character. Press button, get split string. No ads, nonsense or garbage.
...
<span id="copy-to-clipboard">[![](../images/copy-to-clipboard.png "Copy to clipboard")](#)</span> <span id="text-split-submit-undo" class="undo">[(undo)](#)</span>

Want to join lines and strings?

Use the [Join Lines tool](join-lines)!
