tsv-rows-to-columns by HTTrack Website Copier/3.x \[XR&CO'2014\], Mon, 14 Dec 2020 03:25:32 GMT --&gt;
...
Convert Rows to Columns in TSV Files
====================================

web developer and programmer tools
----------------------------------

World's simplest TSV row and column exchanger. Just paste your TSV in the form below, press Convert TSV button, and rows become columns. Press button, invert TSV. No ads, nonsense or garbage.

**Announcement**: We just launched [math tools for developers](../../www.onlinemathtools.com/index68b6.html?msg2). Check it out!

<span id="copy-to-clipboard">[![](../images/copy-to-clipboard.png "Copy to clipboard")](#)</span> <span id="tsv-rows-to-columns-submit-undo" class="undo">[(undo)](#)</span>
...
Use the [Swap TSV Column Order](tsv-swap-columns) tool!

Want to convert TSV columns to rows?

Use the [Convert TSV Columns to Rows](tsv-columns-to-rows) tool!
