js-prettify by HTTrack Website Copier/3.x \[XR&CO'2014\], Mon, 14 Dec 2020 03:24:59 GMT --&gt;
...
World's simplest JavaScript beautifier. Just paste your JS in the form below, press JS Prettify button, and you get beautiful and clean JS. Press button, get JS. No ads, nonsense or garbage.
...
<span id="copy-to-clipboard">[![](../images/copy-to-clipboard.png "Copy to clipboard")](#)</span> <span id="js-prettify-submit-undo" class="undo">[(undo)](#)</span>

Want to minify JavaScript?

Use the [JavaScript minifier tool](js-minify)!
