tsv-prepend-column by HTTrack Website Copier/3.x \[XR&CO'2014\], Mon, 14 Dec 2020 03:25:34 GMT --&gt;
...
Add a TSV Column at the Beginning of TSV
========================================

web developer and programmer tools
----------------------------------

World's simplest online TSV column prepender. Just paste your TSV and the new column in the forms below, press Prepend a TSV Column button, and a new column gets added at the beginning of TSV. Press button, prepend column. No ads, nonsense or garbage.

**Announcement**: We just launched [Online Fractal Tools](../../www.onlinefractaltools.com/index0ff4.html?msg9) – a collection of browser-based fractal generators. Check it out!

TSV:

New column (including the column title):

<span id="copy-to-clipboard">[![](../images/copy-to-clipboard.png "Copy to clipboard")](#)</span> <span id="tsv-prepend-column-submit-undo" class="undo">[(undo)](#)</span>

Want to append TSV columns?

Use the [Append TSV Columns](tsv-append-column) tool!

Want to insert TSV columns?

Use the [Insert TSV Columns](tsv-insert-column) tool!

Want to swap TSV columns?

Use the [Swap TSV Columns](tsv-swap-columns) tool!

Want to extract TSV columns?

Use the [Extract TSV Columns](tsv-extract-column) tool!

Want to replace TSV columns?

Use the [Replace TSV Columns](tsv-replace-column) tool!
