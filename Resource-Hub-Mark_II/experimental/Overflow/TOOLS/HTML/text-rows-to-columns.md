text-rows-to-columns by HTTrack Website Copier/3.x \[XR&CO'2014\], Mon, 14 Dec 2020 03:25:41 GMT --&gt;
...
Convert Rows to Columns in Text Files
=====================================

web developer and programmer tools
----------------------------------

World's simplest text data row to column transformer. Just paste your data in the form below, press Convert button, and rows get converted to columns. Press button, invert text data. No ads, nonsense or garbage.
...
<span id="copy-to-clipboard">[![](../images/copy-to-clipboard.png "Copy to clipboard")](#)</span> <span id="text-rows-to-columns-submit-undo" class="undo">[(undo)](#)</span>

Want to extract text columns?

Use the [Column Extractor](extract-column) tool!

Want to swap text column order?

Use the [Swap Columns](swap-columns) tool!

Want to convert text columns to rows?

Use the [Convert Columns to Rows](text-columns-to-rows) tool!
