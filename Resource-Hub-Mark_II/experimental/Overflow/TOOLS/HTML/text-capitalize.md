text-capitalize by HTTrack Website Copier/3.x \[XR&CO'2014\], Mon, 14 Dec 2020 03:28:38 GMT --&gt;
...
World's simplest word capitalizer. Just paste text in the form below, press Convert button, and you get proper case text. Press button, get text. No ads, nonsense or garbage. Works with Unicode and UTF8 as well.
...
<span id="copy-to-clipboard">[![](../images/copy-to-clipboard.png "Copy to clipboard")](#)</span> <span id="text-capitalize-submit-undo" class="undo">[(undo)](#)</span>

Need to titlecase text instead of capitalizing?

Use [Text to Titlecase Converter](text-titlecase)!

Need to uppercase text instead of capitalizing?

Use [Text to Uppercase Converter](text-uppercase)!
