gray-to-oct by HTTrack Website Copier/3.x \[XR&CO"2014\], Mon, 14 Dec 2020 03:29:25 GMT --&gt;
...
Convert Gray Code to Oct
========================

web developer and programmer tools
----------------------------------

World"s simplest octal Gray code calculator. Just paste your Gray code in the form below, press Convert button, and you get an octal. Press button, get oct. No ads, nonsense or garbage.
...
<span id="copy-to-clipboard">[![](../images/copy-to-clipboard.png "Copy to clipboard")](#)</span> <span id="gray-to-oct-submit-undo" class="undo">[(undo)](#)</span>

Want to convert octal to Gray code?

Use the [Oct to Gray code converter](oct-to-gray)!
