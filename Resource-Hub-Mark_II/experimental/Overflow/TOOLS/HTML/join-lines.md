join-lines by HTTrack Website Copier/3.x \[XR&CO'2014\], Mon, 14 Dec 2020 03:29:02 GMT --&gt;
...
World's simplest line break and newline remover. Just paste your text in the form below, press Join Lines button, and you get merged lines. Press button, get joined text. No ads, nonsense or garbage.
...
Join by: (space by default)

<span id="copy-to-clipboard">[![](../images/copy-to-clipboard.png "Copy to clipboard")](#)</span> <span id="join-lines-submit-undo" class="undo">[(undo)](#)</span>

Want to split strings into words?

Use the [Split String tool](text-split)!
