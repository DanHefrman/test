thousands-separator by HTTrack Website Copier/3.x \[XR&CO'2014\], Mon, 14 Dec 2020 03:29:07 GMT --&gt;
...
World's simplest digits formatter. Just paste your numbers in the form below, press Add Separators button, and you get thousands separated in groups. Press button, get numbers. No ads, nonsense or garbage. Works with US locale only.
...
<span id="copy-to-clipboard">[![](../images/copy-to-clipboard.png "Copy to clipboard")](#)</span> <span id="thousands-separator-submit-undo" class="undo">[(undo)](#)</span>

Number separator:

Want to remove thousands separators?

Use the [remove punctuation](remove-punctuation) or [text replace](text-replace) tool!
