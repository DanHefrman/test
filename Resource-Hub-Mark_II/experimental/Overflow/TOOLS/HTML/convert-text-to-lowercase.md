...
World"s simplest browser-based utility for converting text to lowercase. Load your text in the input form on the left and you"ll instantly get lowercase text in the output area. Powerful, free, and fast. Load text – get lowercase text. Created by developers from team broowserools.
...
<span class="data-type">lowercase text</span> <span class="status"></span>
...
<span class="primary">Text to lowercase converter tool</span> <span class="secondary">What is a text to lowercase converter?</span>

With this tool you can convert letters of input text into lowercase. It accepts arbitrarily large text and returns a lowercase version of this text, regardless of its initial casing. Textabulous!

<span class="primary">Text to lowercase converter examples</span> <span class="secondary">Click to use</span>

Origin of Cats

In this example, we provide text about the origin of cats in uppercase and transform it to lowercase.

CATS HAVE BEEN DOMESTICATED FOR AROUND 4,000 YEARS IN ANCIENT EGYPT. THEY WERE ONCE VALUED FOR THEIR EXCELLENT HUNTING ABILITIES; NOW THEY ARE LOVED FOR THEIR COMPANIONSHIP AND LOVING BEHAVIOR.

cats have been domesticated for around 4,000 years in ancient egypt. they were once valued for their excellent hunting abilities; now they are loved for their companionship and loving behavior.

Arbitrary Case to Lowercase

This example puts arbitrary case text to lowercase.
...
<span class="muted"><span class="green">https://</span>onlinetexttools.com/convert-text-to-lowercase</span><span class="underline">?input</span>=CATS%20HAVE%20BEEN%20DOMESTICATED%20FOR%20AROUND%204%2C000%20YEARS%20IN%20ANCIENT%20EGYPT.%20THEY%20WERE%20ONCE%20VALUED%20FOR%20THEIR%20EXCELLENT%20HUNTING%20ABILITIES%3B%20NOW%20THEY%20ARE%20LOVED%20FOR%20THEIR%20COMPANIONSHIP%20AND%20LOVING%20BEHAVIOR.
