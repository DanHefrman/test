...
Text spaces to newlines converter
=================================

World"s simplest text tool
--------------------------

World"s simplest browser-based utility for converting spaces to newlines in text. Load your text in the input form on the left and you"ll instantly get text with newlines instead of spaces in the output area. Powerful, free, and fast. Load text – get newlines instead of spaces. Created by developers from team broowserools.
...
Text spaces to newlines converter options

<span class="option-group-legend">Tabs Options</span>

Include Tabs <span class="option-details">Convert tabs to newlines as well.</span>

<span class="primary">Text spaces to newlines converter tool</span> <span class="secondary">What is a text spaces to newlines converter?</span>

With this tool you can convert spaces to newlines in text. All existing newlines are passed through and are not modified. It"s also possible to convert all tabs to newlines by enabling the include-tabs option above. Textabulous!

<span class="primary">Text spaces to newlines converter examples</span> <span class="secondary">Click to use</span>

A Column of Text

In this example, we replace all spaces with newlines and get a single column of text in which each word is written on a new line.
...
This example shows how text that has tabs gets treated. Because we"ve enabled include-tabs function, all tabs get turned into newlines, and as a result we get a vertical list of baby animal names.

kitten puppy chick calf fawn duckling foal piglet lamb
...
<span class="muted"><span class="green">https://</span>onlinetexttools.com/convert-spaces-to-newlines</span><span class="underline">?input</span>=A%20single%20cloud%20can%20weight%20more%20than%20one%20million%20pounds&tabs-as-spaces=false
