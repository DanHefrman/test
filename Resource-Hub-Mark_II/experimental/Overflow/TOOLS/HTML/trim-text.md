...
World's simplest browser-based utility for trimming text. Load your text in the input form on the left and you'll instantly get trimmed text on the right. Powerful, free, and fast. Load plain text – get trimmed text. Created by developers from team broowserools.
...
<span class="data-type">trimmed text</span> <span class="status"></span>
...
Text trimmer options

<span class="option-group-legend">Trimming and Lines</span>

Left-Side Trimming <span class="option-details">Trim text on the left side.</span>

Right-Side Trimming <span class="option-details">Trim text on the right side.</span>

Line-by-line Trimming <span class="option-details">Trim text on each line separately.</span>

<span class="primary">Text trimmer tool</span> <span class="secondary">What is a text trimmer?</span>

With this tool you can left-trim and right-trim text. You can selectively remove extra spaces only from the right side, or only from the left, or if you enable both options, then both sides (selected by default). You can also process several text lines individually by using the line-by-line trimming function. Textabulous!

<span class="primary">Text trimmer examples</span> <span class="secondary">Click to use</span>

Double-Sided Trimming

This example removes extra spaces at the beginning and end of the text.
...
In this example, we remove indentation from text paragraphs by using the line-by-line trimming option. Each paragraph of text gets left-trimmed individually and indentation is gone.

Authors traditionally divide their thoughts and arguments into sequences of paragraphs. The part of the text between two such indents, characterized by unity and relative completeness of the content. Paragraph contributes to the correct and rapid perception of the text.
...
This example left-trims and right-trims the names of programming languages on every line.
...
<span class="muted"><span class="green">https://</span>onlinetexttools.com/trim-text</span><span class="underline">?input</span>=%20%20%20%20%20%20%20%20It%27s%20better%20to%20spend%20time%20on%20something%20useful%20and%20interesting%20than%20manually%20removing%20spaces.%20%20%20%20%20%20%20%20%20&left-trim=true&right-trim=true&multi-line=false
