mariadb-password by HTTrack Website Copier/3.x \[XR&CO'2014\], Mon, 14 Dec 2020 03:28:14 GMT --&gt;
...
MariaDB Password Creator
========================

web developer and programmer tools
----------------------------------

World's simplest MariaDB password generator. Just paste your password in the form below, press Generate PASSWORD() button, and you get the MariaDB pass. Press button, get password. No ads, nonsense or garbage.
...
<span id="copy-to-clipboard">[![](../images/copy-to-clipboard.png "Copy to clipboard")](#)</span> <span id="mariadb-password-submit-undo" class="undo">[(undo)](#)</span>
