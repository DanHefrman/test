tsv-delete-column by HTTrack Website Copier/3.x \[XR&CO'2014\], Mon, 14 Dec 2020 03:25:33 GMT --&gt;
...
World's simplest online TSV column deleter. Just paste your tab separated values in the form below, enter column number, press Delete TSV Column button, and the column gets removed. Press button, drop column. No ads, nonsense or garbage.

**Announcement**: We just launched [<span style="color: #e05745">DEV</span><span style="color: #5581b5">URLS</span>](../../devurls.com/index2d29.html?msg6) – a neat developer news aggregator. [Check it out!](../../devurls.com/index098e.html?msg6c)

Column number:

<span id="copy-to-clipboard">[![](../images/copy-to-clipboard.png "Copy to clipboard")](#)</span> <span id="tsv-delete-column-submit-undo" class="undo">[(undo)](#)</span>
