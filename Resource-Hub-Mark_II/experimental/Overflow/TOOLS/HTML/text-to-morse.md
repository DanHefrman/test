text-to-morse by HTTrack Website Copier/3.x \[XR&CO'2014\], Mon, 14 Dec 2020 03:29:11 GMT --&gt;
...
World's simplest online English text to Morse code translator. Just paste your text in the form below, press Convert to Morse Code button, and you get Morse-encoded string. Press button, get Morse code. No ads, nonsense or garbage.
...
<span id="copy-to-clipboard">[![](../images/copy-to-clipboard.png "Copy to clipboard")](#)</span> <span id="text-to-morse-submit-undo" class="undo">[(undo)](#)</span>

Want to decode Morse code?

Use the [Morse Code to Text Converter tool](morse-to-text)!
