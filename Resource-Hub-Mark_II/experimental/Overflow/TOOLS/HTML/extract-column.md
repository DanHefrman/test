extract-column by HTTrack Website Copier/3.x \[XR&CO"2014\], Mon, 14 Dec 2020 03:25:36 GMT --&gt;
...
Export Arbitrary Delimited Columns
==================================

web developer and programmer tools
----------------------------------

World"s simplest delimited column extracter. Just paste your delimited text, string or file in the form below, press Extract Column button, and you get that column extracted. Press button, get column. No ads, nonsense or garbage.

**Announcement**: We just launched [Online Math Tools](../../www.onlinemathtools.com/index3fcc.html?msg1) – a collection of utilities for solving math problems. Check it out!

Column number:

Column delimiter:

<span id="copy-to-clipboard">[![](../images/copy-to-clipboard.png "Copy to clipboard")](#)</span> <span id="extract-column-submit-undo" class="undo">[(undo)](#)</span>

Want to extract CSV columns?

Use the [CSV Column Extractor](csv-extract-column) tool!

Want to swap arbitrary separated columns?

Use the [Swap Text Columns](swap-columns) tool!

Want to replace arbitrary separated columns?

Use the [Change Text Columns](replace-column) tool!

Want to change text column separator symbol?

Use the [Change Text Column Separator Symbol](change-delimiter) tool!

Want to rotate (transpose) text?

Use the [Transpose Text](text-transpose) tool!
...
extract-column by HTTrack Website Copier/3.x \[XR&CO"2014\], Mon, 14 Dec 2020 03:25:37 GMT --&gt;
