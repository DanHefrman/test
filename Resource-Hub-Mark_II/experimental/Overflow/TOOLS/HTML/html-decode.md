html-decode by HTTrack Website Copier/3.x \[XR&CO"2014\], Mon, 14 Dec 2020 03:24:54 GMT --&gt;
...
World"s simplest HTML decoder. Just paste your HTML in the form below, press HTML Decode button, and you get unescaped HTML. Press button, get HTML. No ads, nonsense or garbage.
...
<span id="copy-to-clipboard">[![](../images/copy-to-clipboard.png "Copy to clipboard")](#)</span> <span id="html-decode-submit-undo" class="undo">[(undo)](#)</span>

Want to encode HTML?

Use the [HTML encoder tool](html-encode)!
