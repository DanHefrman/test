random-tsv by HTTrack Website Copier/3.x \[XR&CO'2014\], Mon, 14 Dec 2020 03:29:13 GMT --&gt;
...
Generate Random TSV Files
=========================

web developer and programmer tools
----------------------------------

World's simplest random TSV generator. Just press Generate TSV button, and you get a random TSV file. Press button, get TSV. No ads, nonsense or garbage.
...
<span id="copy-to-clipboard">[![](../images/copy-to-clipboard.png "Copy to clipboard")](#)</span> <span id="random-tsv-submit-undo" class="undo">[(undo)](#)</span>
