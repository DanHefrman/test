text-trim by HTTrack Website Copier/3.x \[XR&CO'2014\], Mon, 14 Dec 2020 03:28:48 GMT --&gt;
...
World's simplest string trimmer. Just paste your text in the form below, press Trim Text Lines button, and your lines get trimmed. Press button, trim lines. No ads, nonsense or garbage.

**Announcement**: We just launched [math tools for developers](../../www.onlinemathtools.com/index68b6.html?msg2). Check it out!

<span id="copy-to-clipboard">[![](../images/copy-to-clipboard.png "Copy to clipboard")](#)</span> <span id="text-trim-submit-undo" class="undo">[(undo)](#)</span>
