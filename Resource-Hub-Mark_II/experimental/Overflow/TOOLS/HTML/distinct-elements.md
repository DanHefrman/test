distinct-elements by HTTrack Website Copier/3.x \[XR&CO"2014\], Mon, 14 Dec 2020 03:29:09 GMT --&gt;
...
World"s simplest distinct list element finder. Just paste your lists in the forms below, press Find Distinct Items button, and you get a list of items that are unique in both lists. Press button, get list difference. No ads, nonsense or garbage.
...
<span id="copy-to-clipboard">[![](../images/copy-to-clipboard.png "Copy to clipboard")](#)</span> <span id="distinct-elements-submit-undo" class="undo">[(undo)](#)</span>
