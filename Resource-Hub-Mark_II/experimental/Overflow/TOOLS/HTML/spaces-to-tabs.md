spaces-to-tabs by HTTrack Website Copier/3.x \[XR&CO'2014\], Mon, 14 Dec 2020 03:26:00 GMT --&gt;
...
World's simplest spaces to tabs converter. Just paste your text in the form below, press Convert Spaces button, and you get spaces replaced with tabs. Press button, get tabs. No ads, nonsense or garbage.
...
<span id="copy-to-clipboard">[![](../images/copy-to-clipboard.png "Copy to clipboard")](#)</span> <span id="spaces-to-tabs-submit-undo" class="undo">[(undo)](#)</span>

Want to convert tabs to spaces instead?

Use the [Tabs to Spaces replacer](tabs-to-spaces)!
