binary-not by HTTrack Website Copier/3.x \[XR&CO"2014\], Mon, 14 Dec 2020 03:29:29 GMT --&gt;
...
World"s simplest bitwise NOT calculator. Just paste your binary numbers in the form below, press Compute Binary NOT button, and you get binary bitwise NOT of every binary value. Press button, NOT binary. No ads, nonsense or garbage.
...
<span id="copy-to-clipboard">[![](../images/copy-to-clipboard.png "Copy to clipboard")](#)</span> <span id="binary-not-submit-undo" class="undo">[(undo)](#)</span>
