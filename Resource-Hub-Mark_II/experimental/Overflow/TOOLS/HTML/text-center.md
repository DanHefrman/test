text-center by HTTrack Website Copier/3.x \[XR&CO'2014\], Mon, 14 Dec 2020 03:28:48 GMT --&gt;
...
World's simplest string and text centering tool. Just paste your text in the form below, press Center Text button, and every line of your text gets centered. Press button, get center text. No ads, nonsense or garbage.
...
Padding symbol: (space by default)

<span id="copy-to-clipboard">[![](../images/copy-to-clipboard.png "Copy to clipboard")](#)</span> <span id="text-center-submit-undo" class="undo">[(undo)](#)</span>
