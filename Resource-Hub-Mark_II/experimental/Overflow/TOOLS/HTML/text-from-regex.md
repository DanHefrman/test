text-from-regex by HTTrack Website Copier/3.x \[XR&CO'2014\], Mon, 14 Dec 2020 03:29:03 GMT --&gt;
...
<span id="copy-to-clipboard">[![](../images/copy-to-clipboard.png "Copy to clipboard")](#)</span> <span id="text-from-regex-submit-undo" class="undo">[(undo)](#)</span>

Regex:

How many results?

Want to extract regex matches from text?

Use the [regex matches](regex-extract-matches) tool!
