tsv-swap-columns by HTTrack Website Copier/3.x \[XR&CO'2014\], Mon, 14 Dec 2020 03:25:36 GMT --&gt;
...
Exchange TSV Columns
====================

web developer and programmer tools
----------------------------------

World's simplest TSV column order swapper. Just paste your TSV in the form below, press Swap TSV Columns button, and you get TSV columns exchanged. Press button, swap columns. No ads, nonsense or garbage.
...
<span id="copy-to-clipboard">[![](../images/copy-to-clipboard.png "Copy to clipboard")](#)</span> <span id="tsv-swap-columns-submit-undo" class="undo">[(undo)](#)</span>
