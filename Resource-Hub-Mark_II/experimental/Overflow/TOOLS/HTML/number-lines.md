number-lines by HTTrack Website Copier/3.x \[XR&CO'2014\], Mon, 14 Dec 2020 03:28:59 GMT --&gt;
...
World's simplest line numbering tool. Just paste your text in the form below, press Number Lines button, and you get numbered lines. Press button, get lines. No ads, nonsense or garbage.
...
<a href="#" id="number-lines-format">(change numbering format)</a>

Line number format:

(NR means current line number.)

<span id="copy-to-clipboard">[![](../images/copy-to-clipboard.png "Copy to clipboard")](#)</span> <span id="number-lines-submit-undo" class="undo">[(undo)](#)</span>
