oct-to-dec by HTTrack Website Copier/3.x \[XR&CO'2014\], Mon, 14 Dec 2020 03:29:19 GMT --&gt;
...
World's simplest octal number converter. Just paste your oct numbers in the form below, press Convert button, and you get decimal integers. Press button, get decimal. No ads, nonsense or garbage.
...
<span id="copy-to-clipboard">[![](../images/copy-to-clipboard.png "Copy to clipboard")](#)</span> <span id="oct-to-dec-submit-undo" class="undo">[(undo)](#)</span>

Want to convert decimal to octal?

Use the [Dec to oct converter](dec-to-oct)!
