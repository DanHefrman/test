sha1-hash by HTTrack Website Copier/3.x \[XR&CO'2014\], Mon, 14 Dec 2020 03:27:22 GMT --&gt;
...
World's simplest SHA1 checksum calculator. Just paste your text in the form below, press Calculate SHA1 button, and you get the SHA1 digest. Press button, get SHA1. No ads, nonsense or garbage.
...
<span id="copy-to-clipboard">[![](../images/copy-to-clipboard.png "Copy to clipboard")](#)</span> <span id="sha1-hash-submit-undo" class="undo">[(undo)](#)</span>
