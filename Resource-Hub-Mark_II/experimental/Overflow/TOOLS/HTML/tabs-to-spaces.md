tabs-to-spaces by HTTrack Website Copier/3.x \[XR&CO'2014\], Mon, 14 Dec 2020 03:26:00 GMT --&gt;
...
World's simplest tabs to spaces converter. Just paste your text in the form below, press Convert Tabs button, and you get tabs replaced with spaces. Press button, get spaces. No ads, nonsense or garbage.
...
<span id="copy-to-clipboard">[![](../images/copy-to-clipboard.png "Copy to clipboard")](#)</span> <span id="tabs-to-spaces-submit-undo" class="undo">[(undo)](#)</span>

Want to convert tabs to spaces instead?

Use the [Spaces to Tabs replacer](spaces-to-tabs)!
