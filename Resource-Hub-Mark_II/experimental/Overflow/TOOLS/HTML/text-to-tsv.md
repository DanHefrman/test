text-to-tsv by HTTrack Website Copier/3.x \[XR&CO'2014\], Mon, 14 Dec 2020 03:25:25 GMT --&gt;
...
Convert Text Columns to TSV
===========================

web developer and programmer tools
----------------------------------

World's simplest online text to TSV converter. Just paste your text column data in the form below, press Convert Text to TSV button, and you get tab separated values. Press button, get TSV. No ads, nonsense or garbage.
...
<span id="copy-to-clipboard">[![](../images/copy-to-clipboard.png "Copy to clipboard")](#)</span> <span id="text-to-tsv-submit-undo" class="undo">[(undo)](#)</span>

Want to convert TSV to text columns instead?

Use the [TSV to Text Columns converter tool](tsv-to-text)!

Want to change spaces that separate columns to some other symbol?

Use the [Change Text Column Separator tool](change-delimiter)!
