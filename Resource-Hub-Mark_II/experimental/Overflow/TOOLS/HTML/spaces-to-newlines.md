spaces-to-newlines by HTTrack Website Copier/3.x \[XR&CO'2014\], Mon, 14 Dec 2020 03:26:01 GMT --&gt;
...
World's simplest spaces to line breaks converter. Just paste your text in the form below, press Convert Spaces button, and you get spaces and tabs replaced with newlines. Press button, get columns of words. No ads, nonsense or garbage.
...
<span id="copy-to-clipboard">[![](../images/copy-to-clipboard.png "Copy to clipboard")](#)</span> <span id="spaces-to-newlines-submit-undo" class="undo">[(undo)](#)</span>

Want to convert newlines to spaces?

Use the [line breaks to spaces tool](newlines-to-spaces)!
