json-unescape by HTTrack Website Copier/3.x \[XR&CO'2014\], Mon, 14 Dec 2020 03:24:58 GMT --&gt;
...
World's simplest JSON unescaper. Just paste your JSON in the form below, press JSON Unescape button, and you get unescaped JSON. Press button, unescape JSON. No ads, nonsense or garbage.
...
<span id="copy-to-clipboard">[![](../images/copy-to-clipboard.png "Copy to clipboard")](#)</span> <span id="json-unescape-submit-undo" class="undo">[(undo)](#)</span>

Want to escape JSON?

Use the [JSON Escaper tool](json-escape)!
