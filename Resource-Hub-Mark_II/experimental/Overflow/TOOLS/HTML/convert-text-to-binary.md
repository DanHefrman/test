...
World"s simplest browser-based utility for converting text to binary. Load your text in the input form on the left and you"ll instantly get binary in the output area. Powerful, free, and fast. Load text – get binary. Created by developers from team broowserools.
...
<span class="data-type">binary text</span> <span class="status"></span>
...
Text to binary converter options

<span class="option-group-legend">Byte Length</span>

Equal Length <span class="option-details">Make all bytes equal length by adding zeros in front of them where their length is less than 8 bits.</span>

<span class="option-group-legend">Byte Splitting</span>

Separate Individual Bytes <span class="option-details">Separate bytes by spaces.</span>

<span class="primary">Text to binary converter tool</span> <span class="secondary">What is a text to binary converter?</span>

With this tool you can convert plain text to binary. It takes each character in a text, finds its binary value and outputs it. By default, it adds a space between every eight bits for better readability. You can toggle it, and then all binary values will be merged together into a continuous stream of zeros and ones. Also, for more compact output, you can remove the beginning zeros in front of bytes that doesn"t affect their values. Textabulous!

<span class="primary">Text to binary converter examples</span> <span class="secondary">Click to use</span>

Fact About the Eiffel Tower

This example converts a short fact about the Eiffel Tower into a binary text.

The Eiffel Tower has 1,792 steps.

01010100 01101000 01100101 00100000 01000101 01101001 01100110 01100110 01100101 01101100 00100000 01010100 01101111 01110111 01100101 01110010 00100000 01101000 01100001 01110011 00100000 00110001 00101100 00110111 00111001 00110010 00100000 01110011 01110100 01100101 01110000 01110011 00101110
...
In this example, we convert facts about giant pandas into a binary stream. For compactness, we"ve removed all spaces between the bytes.

Giant pandas are black and white bears. In the wild, they are found in thick bamboo forests, high up in the mountains of central China. Pandas' favorite delicacy is bamboo, although panda is considered a predatory animal. Every day they eat up to 12 kilograms of bamboo for 12 hours.


...
<span class="muted"><span class="green">https://</span>onlinetexttools.com/convert-text-to-binary</span><span class="underline">?input</span>=The%20Eiffel%20Tower%20has%201%2C792%20steps.&padding=true&spacing=true
