uuencode by HTTrack Website Copier/3.x \[XR&CO'2014\], Mon, 14 Dec 2020 03:26:01 GMT --&gt;
...
World's simplest uuencoder. Just paste your string or text in the form below, press Uuencode button, and you get uuencoded data. Press button, get Unix-to-Unix data. No ads, nonsense or garbage.
...
<span id="copy-to-clipboard">[![](../images/copy-to-clipboard.png "Copy to clipboard")](#)</span> <span id="uu-encode-submit-undo" class="undo">[(undo)](#)</span>

Want to uudecode?

Use the [uudecoder tool](uudecode)!
