...
World's simplest browser-based utility for randomizing letter case in text. Load your text in the input form on the left and you'll instantly get back a random case version in the output area. Powerful, free, and fast. Load text – get its case randomized. Created by developers from team broowserools.
...
<span class="data-type">random case text</span> <span class="status"></span>
...
Randomize text's case again

<span class="primary">Text case randomizer tool</span> <span class="secondary">What is a text case randomizer?</span>

With this tool you can randomize the case of characters in text. The tool arbitrarily selects the lower or upper case version of each character. Press the button below the input/output forms to shuffle the letter case again. Textabulous!

<span class="primary">Text case randomizer examples</span> <span class="secondary">Click to use</span>

Randomize Mark Rylance Quote

This example randomizes the character case of input text, creating pleasant chaos in a marvelous quote by Mark Ryloans.
...
In this example, we randomize the case of letters in a text fragment about chaos theory. Each time you click on the example, you'll get a new result with different casing.

Chaos theory is a part of mathematics that considers very sensitive systems. A very small change may make the system behave completely differently. Chaos theory can be used to explain complex systems such as weather, astronomy, politics, and economics.
...
<span class="muted"><span class="green">https://</span>onlinetexttools.com/randomize-text-case</span><span class="underline">?input</span>=Chaos%20can%20be%20incredibly%20creative.
