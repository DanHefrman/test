...
Text unigrams generator
=======================

World"s simplest text tool
--------------------------

World"s simplest browser-based utility for creating unigrams from text. Load your text in the input form on the left and you"ll instantly get unigrams in the output area. Powerful, free, and fast. Load text – get monograms. Created by developers from team broowserools.
...
<span class="data-type">unigrams</span> <span class="status"></span>
...
Text unigrams generator options

<span class="option-group-legend">Unigram Units</span>

Use Words as Unigram Units <span class="option-details">Build unigrams from words of the input text.</span>

Use Letters as Unigram Units <span class="option-details">Build unigrams from letters of the input text.</span>

Space Symbol in Letter Mode <span class="option-details">If letters are selected as unigram units, then use this char for space.</span>

<span class="option-group-legend">Unigram Delimiter and Case</span>

Unigram Words Delimiter <span class="option-details">Place this symbol between single monogram values.</span>

Lowercase Output <span class="option-details">Output all monograms in lowercase.</span>

<span class="option-group-legend">Unigram Punctuation</span>

Clear Punctuation <span class="option-details">Activate this function to delete punctuation symbols listed below.</span>

Punctuation Symbols <span class="option-details">Enter unwanted punctuation symbols here.</span>

<span class="primary">Text unigrams generator tool</span> <span class="secondary">What is a text unigrams generator?</span>

With this tool, you can create a list of all unigrams from the given text. A unigram, also known as a monogram or 1-gram (because in general they are called n-grams, and n here is 1), is a single unit of text, such as a word or a letter. By default, this tool generates a column of lowercase words. You can switch it to letter mode that will generate a column of letters and also change the unit separator symbol. This utility automatically removes all basic punctuation symbols from unigrams but if it missed some special characters, you can add them to the list of symbols to be removed. If you want to preserve punctuation, you can turn punctuation removal function off with one click in options. You can also control the output case of unigrams. Textabulous!

<span class="primary">Text unigrams generator examples</span> <span class="secondary">Click to use</span>

Generate a Column of Unigrams

In this example, we create monograms from a quote by J.R.R. Tolkien. Every single word is placed on a new line and you get a column of unigrams. We leave the original letter case and don"t remove punctuation.
...
A List of Clean Unigrams

In this example, we extract unigrams from a quote by William W. Purkey. We activate the function to delete the punctuation symbols, separate monograms by a comma and convert all the words to lowercase.
...
Letters as Unigram Units

In this example, we use letters as unigram units. As a result, each letter of the proverb becomes a single element of the output sequence. All spaces are replaced by the underscore character and each individual monogram is placed on a new line because the unigram separator is set to the newline character.

Fortune favors the bold.

F o r t u n e \_ f a v o r s \_ t h e \_ b o l d
...
<span class="muted"><span class="green">https://</span>onlinetexttools.com/generate-text-unigrams</span><span class="underline">?input</span>=%22A%20single%20dream%20is%20more%20powerful%20than%20a%20thousand%20realities.%22%20-%20J.R.R.%20Tolkien&split-by-words=true&remove-punctuation=false&punctuation-characters=%3F.%2C%21%28%29&unigrams-separator=%5Cn&lowercase=false&letter-space=
