postgres-password by HTTrack Website Copier/3.x \[XR&CO'2014\], Mon, 14 Dec 2020 03:28:25 GMT --&gt;
...
World's simplest Postgres password creator. Just paste your password in the form below, enter your username, press Generate password button, and you get the Postgres password. Press button, get password. No ads, nonsense or garbage.
...
<span id="copy-to-clipboard">[![](../images/copy-to-clipboard.png "Copy to clipboard")](#)</span> <span id="postgres-password-submit-undo" class="undo">[(undo)](#)</span>
