yaml-to-xml by HTTrack Website Copier/3.x \[XR&CO'2014\], Mon, 14 Dec 2020 03:25:17 GMT --&gt;
...
World's simplest YAML to XML converter. Just paste your YAML in the form below, press Convert button, and you get XML. Press button, get XML. No ads, nonsense or garbage.
...
<span id="copy-to-clipboard">[![](../images/copy-to-clipboard.png "Copy to clipboard")](#)</span> <span id="yaml-to-xml-submit-undo" class="undo">[(undo)](#)</span>

Want to convert XML to YAML instead?

Use the [XML to YAML converter tool](xml-to-yaml)!
