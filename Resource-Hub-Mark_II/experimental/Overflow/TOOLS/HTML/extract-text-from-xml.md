...
World"s simplest browser-based utility for extracting text from XML. Load your XML in the input form on the left and you"ll instantly get text in the output area. Powerful, free, and fast. Load XML – get text. Created by developers from team broowserools.
...
<span class="data-type">xml</span> <span class="status"></span>
...
<span class="primary">Xml to text converter tool</span> <span class="secondary">What is a xml to text converter?</span>

With this tool, you can convert an XML document to text. It removes all special XML markup characters, leaving only opening-tag names, attributes, and textual content between tags. In Progress, we"ll add a more refined text extraction algorithm that will allow you to choose which tags and attributes to extract the text from. Textabulous!

<span class="primary">Xml to text converter examples</span> <span class="secondary">Click to use</span>

Extract Text from an XML Chat Message

In this example, we extract text from an XML message that was sent in a chat application between two parties. Only the tag names and their internal text content is left after extraction.

&lt;chat&gt; &lt;msg\_meta\_info&gt; &lt;from&gt;Arnold&lt;/from&gt; &lt;to&gt;Jessica&lt;/to&gt; &lt;/msg\_meta\_info&gt; &lt;msg\_content&gt; Jessica, do you have math lecture notes from yesterday? &lt;/msg\_content&gt; &lt;/chat&gt;

chat msg\_meta\_info from Arnold to Jessica msg\_content Jessica, do you have math lecture notes from yesterday?

Extract XML Attributes

In this example, we convert an XML document that contains restaurant menu information to plain text. Note that if a tag has an attribute, then when it"s converted, it appears after the content of this tag.

&lt;restaurant menu="lunch"&gt; &lt;food&gt; &lt;name&gt;Squid salad&lt;/name&gt; &lt;price&gt;$11.99&lt;/price&gt; &lt;weight&gt;300&lt;/weight&gt; &lt;/food&gt; &lt;food&gt; &lt;name&gt;Grilled veal cutlet&lt;/name&gt; &lt;price&gt;$34.99&lt;/price&gt; &lt;weight&gt;400&lt;/weight&gt; &lt;/food&gt; &lt;/restaurant&gt;

restaurant food name Squid salad price $11.99 weight 300 name Grilled veal cutlet price $34.99 weight 400 \_menu lunch
...
<span class="muted"><span class="green">https://</span>onlinetexttools.com/extract-text-from-xml</span><span class="underline">?input</span>=%3Cchat%3E%0A%20%20%3Cmsg\_meta\_info%3E%0A%20%20%20%20%3Cfrom%3EArnold%3C%2Ffrom%3E%0A%20%20%20%20%3Cto%3EJessica%3C%2Fto%3E%0A%20%20%3C%2Fmsg\_meta\_info%3E%0A%20%20%3Cmsg\_content%3E%0A%20%20%20%20Jessica%2C%20do%20you%20have%20math%20lecture%20notes%20from%20yesterday%3F%0A%20%20%3C%2Fmsg\_content%3E%0A%3C%2Fchat%3E
