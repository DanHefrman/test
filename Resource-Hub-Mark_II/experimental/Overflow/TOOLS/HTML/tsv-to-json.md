tsv-to-json by HTTrack Website Copier/3.x \[XR&CO'2014\], Mon, 14 Dec 2020 03:25:23 GMT --&gt;
...
World's simplest TSV to JSON converter. Just paste your tab separated values in the form below, press Convert button, and you get JSON. Press button, get JSON. No ads, nonsense or garbage.
...
<span id="copy-to-clipboard">[![](../images/copy-to-clipboard.png "Copy to clipboard")](#)</span> <span id="tsv-to-json-submit-undo" class="undo">[(undo)](#)</span>

Want to convert JSON to TSV instead?

Use the [JSON to TSV converter tool](json-to-tsv)!
