random-csv by HTTrack Website Copier/3.x \[XR&CO'2014\], Mon, 14 Dec 2020 03:29:13 GMT --&gt;
...
World's simplest random CSV generator. Just press Generate CSV button, and you get a random CSV file. Press button, get CSV. No ads, nonsense or garbage.
...
<span id="copy-to-clipboard">[![](../images/copy-to-clipboard.png "Copy to clipboard")](#)</span> <span id="random-csv-submit-undo" class="undo">[(undo)](#)</span>
