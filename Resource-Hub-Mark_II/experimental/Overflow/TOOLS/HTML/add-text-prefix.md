...
World"s simplest browser-based utility for adding prefixes to text. Load your text in the input form on the left and you"ll instantly get prefixed text in the output form. Powerful, free, and fast. Load plain text – get prefixed text. Created by developers from team broowserools.
...
<span class="data-type">prefixed text</span> <span class="status"></span>
...
Text prefixer options

<span class="option-group-legend">Prefix Data</span>

Prefix text <span class="option-details">Enter words, letters, or numbers to add in front of the text.</span>

<span class="option-group-legend">Text Prefix Mode</span>

Single Prefix Mode <span class="option-details">Attach prefix only once at the very beginning of text.</span>

Line-by-line Mode <span class="option-details">Attach prefix to the beginning of every text line.</span>

Paragraph Mode <span class="option-details">Attach prefix only to paragraphs. </span>

<span class="option-group-legend">Empty Lines</span>

Skip Empty Lines <span class="option-details">Don"t prefix empty lines.</span>

<span class="option-details">This option only works with line-by-line mode.</span>

<span class="primary">Text prefixer tool</span> <span class="secondary">What is a text prefixer?</span>

With this tool you can prepend a prefix at the beginning of text. You can prepend words, letters, or numbers. Anything that you specify in prefix option will get affixed to text. It has three modes of operation – single-prefix function that will add prefix text only once at the very beginning, line-by-line function that will affix every text line, and paragraph function that will add text to paragraphs only (a paragraph is one or more text lines followed by two new lines.) There"s also a skip-empty-lines function, which when selected will avoid adding prefix to blank text lines. Textabulous!

<span class="primary">Text prefixer examples</span> <span class="secondary">Click to use</span>

Forrest Gump Quote

In this example, we add an affix to a text quote from the Forrest Gump movie. When you load this example, the name of main character automatically appears at the beginning of text.
...
Prefix for Seven Rows

This example keeps calm and adds the same prefix to seven text lines at once via line-by-line prefixing mode. It also skips all empty lines.

carry on love on be happy be yourself get creative drink coffee just do it

keep calm and carry on keep calm and love on keep calm and be happy keep calm and be yourself keep calm and get creative keep calm and drink coffee keep calm and just do it
...
<span class="muted"><span class="green">https://</span>onlinetexttools.com/add-text-prefix</span><span class="underline">?input</span>=Mama%20always%20said%20life%20was%20like%20a%20box%20of%20chocolates.%20You%20never%20know%20what%20you%27re%20gonna%20get.&prefix=Forrest%20Gump%3A%0A&single-prefix-mode=true
