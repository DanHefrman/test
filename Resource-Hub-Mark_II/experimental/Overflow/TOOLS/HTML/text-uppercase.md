text-uppercase by HTTrack Website Copier/3.x \[XR&CO'2014\], Mon, 14 Dec 2020 03:25:56 GMT --&gt;
...
World's simplest text to uppercase converter. Just paste text in the form below, press Convert to Uppercase button, and you get upper case text. Press button, get text. No ads, nonsense or garbage. Works with Unicode and UTF8 as well.
...
<span id="copy-to-clipboard">[![](../images/copy-to-clipboard.png "Copy to clipboard")](#)</span> <span id="text-uppercase-submit-undo" class="undo">[(undo)](#)</span>
