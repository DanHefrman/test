text-reverse by HTTrack Website Copier/3.x \[XR&CO'2014\], Mon, 14 Dec 2020 03:28:43 GMT --&gt;
...
World's simplest string reverser. Just paste your text in the form below, press Reverse button, and you get reversed text. Press button, get text. No ads, nonsense or garbage.
...
<span id="copy-to-clipboard">[![](../images/copy-to-clipboard.png "Copy to clipboard")](#)</span> <span id="text-reverse-submit-undo" class="undo">[(undo)](#)</span>

Want to reverse line order?

Use the [Reverse Lines tool](reverse-lines)!
