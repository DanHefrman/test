dec-to-ip by HTTrack Website Copier/3.x \[XR&CO"2014\], Mon, 14 Dec 2020 03:25:46 GMT --&gt;
...
World"s simplest integer to IP converter. Just paste your decimal IP address in the form below, press Convert button, and you get the IP. Press button, get IP. No ads, nonsense or garbage. Useful if you store your IP address data as integers in your database.
...
<span id="copy-to-clipboard">[![](../images/copy-to-clipboard.png "Copy to clipboard")](#)</span> <span id="dec-to-ip-submit-undo" class="undo">[(undo)](#)</span>

Want to convert IP to decimal instead?

Use the [IP to decimal converter tool](ip-to-dec)!
