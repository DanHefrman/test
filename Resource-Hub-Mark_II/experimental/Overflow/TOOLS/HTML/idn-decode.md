idn-decode by HTTrack Website Copier/3.x \[XR&CO"2014\], Mon, 14 Dec 2020 03:25:14 GMT --&gt;
...
World"s simplest IDN decoder. Just paste your IDN string in the form below, press IDN Decode button, and you get text. Press button, get text. No ads, nonsense or garbage.

**Announcement**: We just launched [math tools for developers](../../www.onlinemathtools.com/index68b6.html?msg2). Check it out!

<span id="copy-to-clipboard">[![](../images/copy-to-clipboard.png "Copy to clipboard")](#)</span> <span id="idn-decode-submit-undo" class="undo">[(undo)](#)</span>

Want to IDN Encode?

Use the [IDN encoder tool](idn-encode)!
