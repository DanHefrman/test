...
World"s simplest browser-based utility for extracting text from HTML. Load your HTML in the input form on the left and you"ll instantly get text in the output area. Powerful, free, and fast. Load HTML – get text. Created by developers from team broowserools.
...
<span class="data-type">html</span> <span class="status"></span>
...
Html to text converter options

<span class="option-group-legend">Line Breaking</span>

Convert &lt;br&gt; into a Line Break <span class="option-details">Turn the &lt;br&gt; tag into an actual line break.</span>

<span class="option-group-legend">Space Around Tags</span>

Collapse Whitespace <span class="option-details">Remove all whitespace around deleted tags.</span>

<span class="primary">Html to text converter tool</span> <span class="secondary">What is a html to text converter?</span>

With this tool, you can convert HTML code to text. It removes all HTML tags and preserves text structure but you can remove it by using the collapse-whitespace option. You can also control the behavior of the &lt;br&gt; tag and make it insert a new line in the output text. In Progress, you"ll be able to choose the tags that you want to extract text from (and ignore text in all other tags). Textabulous!

<span class="primary">Html to text converter examples</span> <span class="secondary">Click to use</span>
...
&lt;body&gt; &lt;header&gt; &lt;h1&gt;Lorem Ipsum&lt;/h1&gt; &lt;/header&gt; &lt;article&gt; &lt;h2&gt;What is lorem ipsum?&lt;/h2&gt; &lt;p&gt;Lorem ipsum is a classic pangram, conditional, often meaningless placeholder text inserted into the page layout.&lt;/p&gt; &lt;/article&gt; &lt;footer&gt; Is a distorted section from the philosophical treatise "On the ends of good and evil" by Cicero. &lt;/footer&gt; &lt;/body&gt;
...
Strip HTML from a Poem

In this example, we strip all tags from a poem written in HTML code. We leave all whitespace characters in their place (by disabling collapse-whitespace option) and enable &lt;br&gt; tag line breaks (by enabling br-tags option).

&lt;html&gt; &lt;head&gt; &lt;meta charset="utf-8"&gt; &lt;title&gt;Poem&lt;/title&gt; &lt;/head&gt; &lt;body&gt; &lt;p&gt;Timothy Egart&lt;/p&gt; &lt;p&gt;The beauty of you&lt;br&gt; is how you wear&lt;br&gt; is who you are.&lt;/p&gt; &lt;/body&gt; &lt;/html&gt;

Poem Timothy Egart The beauty of you is how you wear is who you are.
...
<span class="muted"><span class="green">https://</span>onlinetexttools.com/extract-text-from-html</span><span class="underline">?input</span>=%3Cbody%3E%0A%20%20%3Cheader%3E%0A%20%20%20%20%3Ch1%3ELorem%20Ipsum%3C%2Fh1%3E%0A%20%20%3C%2Fheader%3E%0A%20%20%3Carticle%3E%0A%20%20%20%20%3Ch2%3EWhat%20is%20lorem%20ipsum%3F%3C%2Fh2%3E%0A%20%20%20%20%3Cp%3ELorem%20ipsum%20is%20a%20classic%20pangram%2C%20conditional%2C%20often%20meaningless%20placeholder%20text%20inserted%20into%20the%20page%20layout.%3C%2Fp%3E%0A%20%20%3C%2Farticle%3E%0A%20%20%3Cfooter%3E%0A%20%20%20%20Is%20a%20distorted%20section%20from%20the%20philosophical%20treatise%20%22On%20the%20ends%20of%20good%20and%20evil%22%20by%20Cicero.%0A%20%20%3C%2Ffooter%3E%0A%3C%2Fbody%3E&line-break=false&strip-whitespace=true
