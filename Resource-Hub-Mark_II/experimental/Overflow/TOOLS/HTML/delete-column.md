delete-column by HTTrack Website Copier/3.x \[XR&CO"2014\], Mon, 14 Dec 2020 03:25:37 GMT --&gt;
...
Remove Arbitrary Delimited Columns
==================================

web developer and programmer tools
----------------------------------

World"s simplest online delimited column deleter. Just paste your delimited text, string or file in the form below, press Delete Column button, and that column gets removed. Press button, drop column. No ads, nonsense or garbage.
...
<span id="copy-to-clipboard">[![](../images/copy-to-clipboard.png "Copy to clipboard")](#)</span> <span id="delete-column-submit-undo" class="undo">[(undo)](#)</span>

Want to delete CSV columns?

Use the [CSV Column Deleter](csv-delete-column) tool!

Want to swap arbitrary separated columns?

Use the [Swap Text Columns](swap-columns) tool!

Want to extract arbitrary separated columns?

Use the [Extract Text Columns](extract-column) tool!
