csv-to-yaml by HTTrack Website Copier/3.x \[XR&CO"2014\], Mon, 14 Dec 2020 03:25:24 GMT --&gt;
...
World"s simplest CSV to YAML converter. Just paste your CSV in the form below, press Convert button, and you get YAML. Press button, get YAML. No ads, nonsense or garbage.
...
<span id="copy-to-clipboard">[![](../images/copy-to-clipboard.png "Copy to clipboard")](#)</span> <span id="csv-to-yaml-submit-undo" class="undo">[(undo)](#)</span>

Want to convert YAML to CSV instead?

Use the [YAML to CSV converter tool](yaml-to-csv)!
