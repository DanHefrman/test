text-to-ascii by HTTrack Website Copier/3.x \[XR&CO'2014\], Mon, 14 Dec 2020 03:25:52 GMT --&gt;
...
World's simplest string to ASCII converter. Just paste your text in the form below, press Convert to ASCII button, and you get ASCII values. Press button, get ASCII. No ads, nonsense or garbage.
...
<span id="copy-to-clipboard">[![](../images/copy-to-clipboard.png "Copy to clipboard")](#)</span> <span id="text-to-ascii-submit-undo" class="undo">[(undo)](#)</span>

Want to convert ASCII to text?

Use the [ASCII to Text converter](ascii-to-text)!
