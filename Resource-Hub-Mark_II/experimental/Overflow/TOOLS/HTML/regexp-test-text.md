...
World's simplest browser-based app for testing text with a regexp. Load your text in the input form on the left, enter the regular expression below and you'll instantly get text status in the output area. Powerful, free, and fast. Load text – get regex status. Created by developers from team broowserools.
...
<span class="data-type">text status</span> <span class="status"></span>
...
Text regex tester options

<span class="option-group-legend">Regexp Pattern</span>

/\[a-zA-Z0-9\]+/g

Regular Expression <span class="option-details">Enter the regular expression you want to apply to the text.</span>

<span class="option-group-legend">Multiline Text</span>

Line-by-line Mode <span class="option-details">Split the input text into lines and check each piece individually.</span>

<span class="primary">Text regex tester tool</span> <span class="secondary">What is a text regex tester?</span>
...
<span class="primary">Text regex tester examples</span> <span class="secondary">Click to use</span>
...
1ClxpmLAt WV0qn3ps XxkFcKWq AIl0tFqU9 ZJb3EYDr XRwkQUqRZ asefyx1rg QdyrVJeJi Rt6AP7zr 2CEO2KDGR
...
It snows! It snows! From out the sky The feathered flakes, how fast they fly, Like little birds, that don't know why They're on the chase, from place to place, While neither can the other trace. Snow! Snow! A merry play Is over us, on this heavy day!
...
<span class="muted"><span class="green">https://</span>onlinetexttools.com/regexp-test-text</span><span class="underline">?input</span>=%22Try%20to%20be%20a%20rainbow%20in%20someone%27s%20cloud%22&regex=%5E.%7B40%7D%24&multi-line=false
