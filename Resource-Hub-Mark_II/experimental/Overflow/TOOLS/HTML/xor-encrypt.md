xor-encrypt by HTTrack Website Copier/3.x \[XR&CO'2014\], Mon, 14 Dec 2020 03:26:12 GMT --&gt;
...
World's simplest XOR encryptor. Just paste your text in the form below, enter password, press XOR Encrypt button, and you get XOR encrypted text. Press button, get XOR. No ads, nonsense or garbage.
...
<span id="copy-to-clipboard">[![](../images/copy-to-clipboard.png "Copy to clipboard")](#)</span> <span id="xor-encrypt-submit-undo" class="undo">[(undo)](#)</span>

Want to XOR-decrypt text?

Use the [XOR-decrypt tool](xor-decrypt)!
