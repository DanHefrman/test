grep by HTTrack Website Copier/3.x \[XR&CO"2014\], Mon, 14 Dec 2020 03:29:10 GMT --&gt;
...
World"s simplest string grep. Just paste your text in the form below, press Grep Text button, and you get lines that match the regular expression. Press button, get lines. No ads, nonsense or garbage.
...
<span id="copy-to-clipboard">[![](../images/copy-to-clipboard.png "Copy to clipboard")](#)</span> <span id="grep-submit-undo" class="undo">[(undo)](#)</span>

Regex:

Invert matches:

Want to generate random text lines that match regular expressions?

Use the [text lines from regex tool](text-from-regex)!
