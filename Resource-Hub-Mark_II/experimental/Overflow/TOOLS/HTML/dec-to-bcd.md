dec-to-bcd by HTTrack Website Copier/3.x \[XR&CO"2014\], Mon, 14 Dec 2020 03:29:22 GMT --&gt;
...
World"s simplest BCD encoder. Just paste your decimals in the form below, press Convert button, and you get binary coded decimals. Press button, get BCD. No ads, nonsense or garbage.

**Announcement**: We just launched [math tools for developers](../../www.onlinemathtools.com/index68b6.html?msg2). Check it out!

<span id="copy-to-clipboard">[![](../images/copy-to-clipboard.png "Copy to clipboard")](#)</span> <span id="dec-to-bcd-submit-undo" class="undo">[(undo)](#)</span>

Want to convert BCD to decimal?

Use the [BCD to decimal converter](bcd-to-dec)!
