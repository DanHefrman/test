json-minify by HTTrack Website Copier/3.x \[XR&CO'2014\], Mon, 14 Dec 2020 03:24:57 GMT --&gt;
...
World's simplest JSON minifier. Just paste your JSON in the form below, press JSON Minify button, and you get compressed JSON. Press button, get JSON. No ads, nonsense or garbage.
...
<span id="copy-to-clipboard">[![](../images/copy-to-clipboard.png "Copy to clipboard")](#)</span> <span id="json-minify-submit-undo" class="undo">[(undo)](#)</span>
