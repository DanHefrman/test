roman-to-decimal by HTTrack Website Copier/3.x \[XR&CO'2014\], Mon, 14 Dec 2020 03:25:49 GMT --&gt;
...
World's simplest Roman numerals to integer numbers converter. Just paste a Roman number in the form below, press Convert button, and you get an Arabic numeral. Press button, get decimal. No ads, nonsense or garbage.

**Announcement**: We just launched [math tools for developers](../../www.onlinemathtools.com/index68b6.html?msg2). Check it out!

<span id="copy-to-clipboard">[![](../images/copy-to-clipboard.png "Copy to clipboard")](#)</span> <span id="roman-to-decimal-submit-undo" class="undo">[(undo)](#)</span>

Want to convert decimal to Roman numerals?

Use the [Decimal to Roman converter tool](decimal-to-roman)!
