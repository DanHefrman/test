url-decode by HTTrack Website Copier/3.x \[XR&CO'2014\], Mon, 14 Dec 2020 03:24:52 GMT --&gt;
...
World's simplest URL decoder. Just paste your URL in the form below, press URL Decode button, and you get unescaped URL. Press button, get URL. No ads, nonsense or garbage.
...
<span id="copy-to-clipboard">[![](../images/copy-to-clipboard.png "Copy to clipboard")](#)</span> <span id="url-decode-submit-undo" class="undo">[(undo)](#)</span>

Want to encode a URL?

Use the [URL encoder tool](url-encode)!
