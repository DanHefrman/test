word-wrap by HTTrack Website Copier/3.x \[XR&CO'2014\], Mon, 14 Dec 2020 03:28:57 GMT --&gt;
...
World's simplest word wrapper. Just paste your text in the form below, press Word Wrap button, and you get wrapped text. Press button, get words. No ads, nonsense or garbage.
...
<span id="copy-to-clipboard">[![](../images/copy-to-clipboard.png "Copy to clipboard")](#)</span> <span id="word-wrap-submit-undo" class="undo">[(undo)](#)</span>

Want to join wrapped text lines?

Use the [Line Join tool](join-lines)!
