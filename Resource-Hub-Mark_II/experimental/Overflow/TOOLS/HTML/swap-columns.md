swap-columns by HTTrack Website Copier/3.x \[XR&CO'2014\], Mon, 14 Dec 2020 03:25:38 GMT --&gt;
...
World's simplest text column order swapper. Just paste your text or file in the form below, press Swap Text Columns button, and you columns swapped. Press button, swap columns. No ads, nonsense or garbage.
...
Column delimiter: (space by default)
...
Use the [CSV Column Swapper](csv-swap-columns) tool!

Want to extract arbitrary separated columns?

Use the [Extract Text Column](extract-column) tool!

Want to replace arbitrary separated columns?

Use the [Replace Text Column](replace-column) tool!

Want to change text column delimiter?

Use the [Change Text Column Delimiter](change-delimiter) tool!
