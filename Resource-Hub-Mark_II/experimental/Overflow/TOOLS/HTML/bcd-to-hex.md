bcd-to-hex by HTTrack Website Copier/3.x \[XR&CO"2014\], Mon, 14 Dec 2020 03:29:24 GMT --&gt;
...
World"s simplest hex BCD calculator. Just paste your BCD in the form below, press Convert button, and you get a hexadecimal number. Press button, get hex. No ads, nonsense or garbage.
...
<span id="copy-to-clipboard">[![](../images/copy-to-clipboard.png "Copy to clipboard")](#)</span> <span id="bcd-to-hex-submit-undo" class="undo">[(undo)](#)</span>

Want to convert hex to BCD?

Use the [Hex to BCD converter](hex-to-bcd)!
