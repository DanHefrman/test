ascii85-decode by HTTrack Website Copier/3.x \[XR&CO"2014\], Mon, 14 Dec 2020 03:25:59 GMT --&gt;
...
World"s simplest Ascii85 decoder. Just paste your data in the form below, press Ascii85 Decode button, and you get a base85 decoded string. Press button, get string. No ads, nonsense or garbage.
...
<span id="copy-to-clipboard">[![](../images/copy-to-clipboard.png "Copy to clipboard")](#)</span> <span id="ascii85-decode-submit-undo" class="undo">[(undo)](#)</span>

Want to Ascii85 encode?

Use the [Ascii85 encoder tool](ascii85-encode)!
