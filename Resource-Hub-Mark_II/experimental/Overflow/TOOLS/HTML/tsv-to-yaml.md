tsv-to-yaml by HTTrack Website Copier/3.x \[XR&CO'2014\], Mon, 14 Dec 2020 03:25:18 GMT --&gt;
...
World's simplest TSV to YAML converter. Just paste your tab separated values in the form below, press Convert button, and you get YAML. Press button, get YAML. No ads, nonsense or garbage.

**Announcement**: We just launched [math tools for developers](../../www.onlinemathtools.com/index68b6.html?msg2). Check it out!

<span id="copy-to-clipboard">[![](../images/copy-to-clipboard.png "Copy to clipboard")](#)</span> <span id="tsv-to-yaml-submit-undo" class="undo">[(undo)](#)</span>

Want to convert YAML to TSV instead?

Use the [YAML to TSV converter tool](yaml-to-tsv)!
