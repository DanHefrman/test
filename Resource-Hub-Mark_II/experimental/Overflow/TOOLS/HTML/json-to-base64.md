json-to-base64 by HTTrack Website Copier/3.x \[XR&CO'2014\], Mon, 14 Dec 2020 03:29:37 GMT --&gt;
...
World's simplest base64 JSON encoder. Just paste your JSON data structure in the form below, press Base64 Encode JSON button, and you get a base64-encoded JSON document. Press button, get JSON. No ads, nonsense or garbage.
...
<span id="copy-to-clipboard">[![](../images/copy-to-clipboard.png "Copy to clipboard")](#)</span> <span id="json-to-base64-submit-undo" class="undo">[(undo)](#)</span>

Want to decode a base-64 encoded JSON?
