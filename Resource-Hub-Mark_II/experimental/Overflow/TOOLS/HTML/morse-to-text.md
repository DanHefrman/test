morse-to-text by HTTrack Website Copier/3.x \[XR&CO'2014\], Mon, 14 Dec 2020 03:29:11 GMT --&gt;
...
World's simplest online Morse code to English text translator. Just paste your Morse code in the form below, press Convert Morse Code to Text button, and you get text. Press button, decode Morse code. No ads, nonsense or garbage.
...
<span id="copy-to-clipboard">[![](../images/copy-to-clipboard.png "Copy to clipboard")](#)</span> <span id="morse-to-text-submit-undo" class="undo">[(undo)](#)</span>

Want to encode Morse code?

Use the [Text to Morse Code Converter tool](text-to-morse)!
