csv-append-column by HTTrack Website Copier/3.x \[XR&CO"2014\], Mon, 14 Dec 2020 03:25:29 GMT --&gt;
...
Add a CSV Column at the End of CSV
==================================

web developer and programmer tools
----------------------------------

World"s simplest online CSV column adder. Just paste your CSV and the new column in the forms below, press Append a CSV Column button, and a new column gets added at the end of CSV. Press button, append column. No ads, nonsense or garbage.
...
<span id="copy-to-clipboard">[![](../images/copy-to-clipboard.png "Copy to clipboard")](#)</span> <span id="csv-append-column-submit-undo" class="undo">[(undo)](#)</span>
