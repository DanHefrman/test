text-length by HTTrack Website Copier/3.x \[XR&CO'2014\], Mon, 14 Dec 2020 03:29:06 GMT --&gt;
...
World's simplest character counter. Just paste your text in the form below, press Find Length button, and you get the length of your text. Press button, get length. No ads, nonsense or garbage.
...
<span id="copy-to-clipboard">[![](../images/copy-to-clipboard.png "Copy to clipboard")](#)</span> <span id="text-length-submit-undo" class="undo">[(undo)](#)</span>

Note: Newline is counted as a single character.
