...
World"s simplest browser-based utility for converting text to octal. Load your text in the input form on the left and you"ll instantly get octal text in the output area. Powerful, free, and fast. Load text – get octal. Created by developers from team broowserools.
...
<span class="data-type">octal text</span> <span class="status"></span>
...
Text to octal converter options

<span class="option-group-legend">Byte Separation</span>

Separate Octal Values <span class="option-details">Separate each octet with one space.</span>

<span class="option-group-legend">Octal Prefix</span>

Add Octal Prefix <span class="option-details">Add zeros before octets.</span>

<span class="primary">Text to octal converter tool</span> <span class="secondary">What is a text to octal converter?</span>

With this tool you can convert any text to octal values. For better data visualization, all octets can be separated by spaces. You can easily toggle this visualization in the options. You can also choose to show or not to show the leading zero before each octet. Textabulous!

<span class="primary">Text to octal converter examples</span> <span class="secondary">Click to use</span>

Silly Text to Octal

This example converts a small and silly piece of text to octal numbers. For better visualization of individual octets, we"ve enabled spacing option that adds a space between individual octal values. We"ve also enabled an option that adds a leading zero to each octet.

Octal and nothing else.

0117 0143 0164 0141 0154 040 0141 0156 0144 040 0156 0157 0164 0150 0151 0156 0147 040 0145 0154 0163 0145 056
...
In this example, we transform a fragment of text about DNA into octal values. We"ve disabled the option that adds a leading zero to octets to save some space.
...
105 141 143 150 40 157 146 40 165 163 40 150 141 163 40 66 60 40 342 200 223 40 71 60 40 164 162 151 154 154 151 157 156 40 143 145 154 154 163 40 163 157 40 157 165 162 40 104 116 101 40 151 163 40 166 145 162 171 54 40 166 145 162 171 40 164 151 156 171 40 167 150 145 156 40 143 157 151 154 145 144 40 165 160 56 40 111 146 40 171 157 165 40 143 157 165 154 144 40 164 141 153 145 40 151 164 40 157 165 164 40 157 146 40 141 40 143 145 154 154 40 141 156 144 40 163 164 162 145 164 143 150 40 151 164 40 151 156 164 157 40 141 40 154 151 156 145 54 40 157 165 162 40 104 116 101 40 167 157 165 154 144 40 142 145 40 155 157 162 145 40 164 150 141 156 40 163 151 170 40 146 145 145 164 40 154 157 156 147 56 40 124 150 141 164 47 163 40 141 154 155 157 163 164 40 164 167 157 40 155 145 164 145 162 163 56
...
<span class="muted"><span class="green">https://</span>onlinetexttools.com/convert-text-to-octal</span><span class="underline">?input</span>=Octal%20and%20nothing%20else.&byte-spacing=true&byte-prefix=true
