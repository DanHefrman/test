...
World's simplest browser-based utility for URL-decoding text. Load your text in the input form on the left and you'll automatically get URL-unescaped text on the right. Powerful, free, and fast. Load URL-escaped text – get plain text. Created by developers from team broowserools.
...
<span class="primary">Text url decoder tool</span> <span class="secondary">What is a text url decoder?</span>

With this tool you can URL-unescape text. URL-unescaping is also known as URL-decoding and also percent-decoding. To transmit URLs, some special characters, such as ampersands, slahses, spaces (and many more) are encoded in percent-encoding format. URL-decoding replaces sequences of % and character codes with their corresponding character symbols, making the input text readable for people. Textabulous!

<span class="primary">Text url decoder examples</span> <span class="secondary">Click to use</span>

Christmas Todo List

This example URL-decodes percent-encoded text that's pretty hard to read to a very readable Christmas day todo list.

How%20to%20prepare%20for%20Christmas%3A%0A-%20decorate%20your%20home%0A-%20decorate%20your%20Christmas%20tree%0A-%20watch%20Christmas%20movies%0A-%20buy%20presents%0A-%20bake%20Christmas%20goodies%0A-%20prepare%20your%20Christmas%20dinner%0A-%20celebrate%20Christmas

How to prepare for Christmas: - decorate your home - decorate your Christmas tree - watch Christmas movies - buy presents - bake Christmas goodies - prepare your Christmas dinner - celebrate Christmas

URL-unescape a Web Address

This example shows that you can also use this tool for the most common task, which is URL-decoding previosly URL-encoded web addresses. Here we feed the tool an URL-encoded text URL and get back a plain text URL address.

http%3A%2F%2Fwww.techcompany.com%2Fdigital-electronics%2Finnovations.ps

http://www.techcompany.com/digital-electronics/innovations.ps
...
<span class="muted"><span class="green">https://</span>onlinetexttools.com/url-decode-text</span><span class="underline">?input</span>=How%2520to%2520prepare%2520for%2520Christmas%253A%250A-%2520decorate%2520your%2520home%250A-%2520decorate%2520your%2520Christmas%2520tree%250A-%2520watch%2520Christmas%2520movies%250A-%2520buy%2520presents%250A-%2520bake%2520Christmas%2520goodies%250A-%2520prepare%2520your%2520Christmas%2520dinner%250A-%2520celebrate%2520Christmas
