xml-to-base64 by HTTrack Website Copier/3.x \[XR&CO'2014\], Mon, 14 Dec 2020 03:29:37 GMT --&gt;
...
World's simplest base64 XML encoder. Just paste your XML document in the form below, press Base64 Encode XML button, and you get a base64-encoded XML data structure. Press button, get base64(xml). No ads, nonsense or garbage.
...
<span id="copy-to-clipboard">[![](../images/copy-to-clipboard.png "Copy to clipboard")](#)</span> <span id="xml-to-base64-submit-undo" class="undo">[(undo)](#)</span>

Want to decode a base-64 encoded XML?

Use the [Base64 Decoder](base64-decode)!
