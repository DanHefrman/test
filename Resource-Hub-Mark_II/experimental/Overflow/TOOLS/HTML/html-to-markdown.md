html-to-markdown by HTTrack Website Copier/3.x \[XR&CO"2014\], Mon, 14 Dec 2020 03:25:06 GMT --&gt;
...
<span id="copy-to-clipboard">[![](../images/copy-to-clipboard.png "Copy to clipboard")](#)</span> <span id="html-to-markdown-submit-undo" class="undo">[(undo)](#)</span>

Need to convert Markdown to HTML instead?

Use the [Markdown to HTML Converter](markdown-to-html)!
