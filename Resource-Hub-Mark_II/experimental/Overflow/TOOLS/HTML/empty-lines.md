empty-lines by HTTrack Website Copier/3.x \[XR&CO"2014\], Mon, 14 Dec 2020 03:29:01 GMT --&gt;
...
World"s simplest blank line remover. Just paste your text in the form below, press Remove Empty Lines button, and you get full lines only. Press button, get lines. No ads, nonsense or garbage.
...
<span id="copy-to-clipboard">[![](../images/copy-to-clipboard.png "Copy to clipboard")](#)</span> <span id="empty-lines-submit-undo" class="undo">[(undo)](#)</span>
