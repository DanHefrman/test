base58-decode by HTTrack Website Copier/3.x \[XR&CO"2014\], Mon, 14 Dec 2020 03:25:59 GMT --&gt;
...
World"s simplest base58 decode. Just paste your data in the form below, press Base58 Decode button, and you get a base58 decoded string. Press button, get string. No ads, nonsense or garbage.
...
<span id="copy-to-clipboard">[![](../images/copy-to-clipboard.png "Copy to clipboard")](#)</span> <span id="base58-decode-submit-undo" class="undo">[(undo)](#)</span>

Want to base58 encode?

Use the [Base58 Text Encoder](base58-encode)!
