tsv-append-column by HTTrack Website Copier/3.x \[XR&CO'2014\], Mon, 14 Dec 2020 03:25:34 GMT --&gt;
...
Add a TSV Column at the End of TSV
==================================

web developer and programmer tools
----------------------------------

World's simplest online TSV column adder. Just paste your TSV and the new column in the forms below, press Append a TSV Column button, and a new column gets added at the end of TSV. Press button, append column. No ads, nonsense or garbage.

**Announcement**: We just launched [](../../www.onlinetexttools.com/index2adf.html?msg3) – a collection of browser-based text processing utilities. Check it out!

TSV:

New column (including new column's title):

<span id="copy-to-clipboard">[![](../images/copy-to-clipboard.png "Copy to clipboard")](#)</span> <span id="tsv-append-column-submit-undo" class="undo">[(undo)](#)</span>
