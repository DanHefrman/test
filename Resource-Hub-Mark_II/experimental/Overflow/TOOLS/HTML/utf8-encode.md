utf8-encode by HTTrack Website Copier/3.x \[XR&CO'2014\], Mon, 14 Dec 2020 03:26:00 GMT --&gt;
...
World's simplest UTF8 encoder. Just paste your text in the form below, press UTF8 Encode button, and you get UTF8-encoded data. Press button, get UTF8. No ads, nonsense or garbage. Works with ASCII and Unicode strings.
...
<span id="copy-to-clipboard">[![](../images/copy-to-clipboard.png "Copy to clipboard")](#)</span> <span id="utf8-encode-submit-undo" class="undo">[(undo)](#)</span>

Want to UTF8 decode text?

Use the [UTF8 decoder tool](utf8-decode)!
