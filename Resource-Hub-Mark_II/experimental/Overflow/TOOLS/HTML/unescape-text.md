...
World's simplest browser-based utility for slash-unescaping text. Load your backslash-escaped text in the input form on the left and you'll instantly get text with all backslashes removed on the right. Powerful, free, and fast. Load slash-escaped text – get slash-unescaped text. Created by developers from team broowserools.
...
<span class="data-type">escaped text</span> <span class="status"></span>
...
<span class="data-type">un-escaped text</span> <span class="status"></span>
...
<span class="primary">Text unescaper tool</span> <span class="secondary">What is a text unescaper?</span>

With this tool, you can unescape all slash-escaped symbols in the given text. It has the same behavior as PHP's stripslashes() function. It removes backslashes before quotation marks, returns the tab symbol in place of \\t characters, and puts a newline in place of \\n characters. Textabulous!

<span class="primary">Text unescaper examples</span> <span class="secondary">Click to use</span>

Rene Descartes Quote

In this example, we unescape a famous phrase of Rene Descartes, the great French philosopher and mathematician. As you can see, the tool removes all slashes from double quote marks, newlines, and tabs.

\\"I am thinking, therefore I exist.\\"\\n\\tRene Descartes

"I am thinking, therefore I exist." Rene Descartes

Unescape Multi-line Text

This example loads a previously slash-escaped Murphy and Cooper's dialogue from the Interstellar movie and it removes all slashes from it. Characters \\n, \\" and \\' get turned into a newline symbol, double quote and single quote, respectively.
...
Murph: "Why did you and Mom name me after something that's bad?" Cooper: "We didn't." Murph: "Murphy's Law?" Cooper: "Murphy's Law doesn't mean that something bad will happen. What it means is whatever can happen will happen. And that sounded just fine with us."
...
<span class="muted"><span class="green">https://</span>onlinetexttools.com/unescape-text</span><span class="underline">?input</span>=%5C%22I%20am%20thinking%2C%20therefore%20I%20exist.%5C%22%5Cn%5CtRene%20Descartes
