...
World's simplest browser-based utility for converting text to rot47. Load your text in the input form on the left and you'll instantly get rot47 in the output area. Powerful, free, and fast. Load text – get rot47(text). Created by developers from team broowserools.
...
<span class="data-type">rot47 text</span> <span class="status"></span>
...
<span class="primary">Rot47 converter tool</span> <span class="secondary">What is a rot47 converter?</span>

With this tool, you can encrypt the given text using the ROT47 cipher. Curiously, encrypting to ROT47 twice produces the same text so you can also decrypt any text that was previously ROT47-encrypted. ROT47 comes from the ROT13 algorithm and differs only by additional numbers and characters that it uses in its alphabet. Just like ROT13, ROT47 shifts each text symbol by 47 positions. However, despite it having more characters that seemingly provide more thorough obfuscation, it's no more secure than ROT13. Textabulous!

<span class="primary">Rot47 converter examples</span> <span class="secondary">Click to use</span>

ROT47-encode a Fight Club Rule

In this example, we encipher the first rule of the Fight Club by applying ROT47 cipher.

The first rule of Fight Club is: You do not talk about Fight Club.

%96 7:CDE CF=6 @7 u:89E r=F3 :Di \*@F 5@ ?@E E2=&lt; 23@FE u:89E r=F3\]

ROT-47 Decipher Text

In this example, we demonstrate the inverse property of ROT-47 cipher and decrypt previously ROT-47 encoded text.

xV&gt; 27C2:5 @7 &gt;J 4@&gt;AFE6C\] x &lt;?@H H96? x EFC? :E @77\[ :EVD =62C?:?8 ?6H E9:?8D H:E9@FE &gt;6\]
...
<span class="muted"><span class="green">https://</span>onlinetexttools.com/rot47-text</span><span class="underline">?input</span>=The%20first%20rule%20of%20Fight%20Club%20is%3A%20You%20do%20not%20talk%20about%20Fight%20Club.
