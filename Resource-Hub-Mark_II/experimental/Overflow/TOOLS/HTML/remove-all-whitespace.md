remove-all-whitespace by HTTrack Website Copier/3.x \[XR&CO'2014\], Mon, 14 Dec 2020 03:29:07 GMT --&gt;
...
World's simplest whitespace, tab and newline deleter. Just paste your text in the form below, press Remove All Spaces button, and you get a single string back with no spaces. Press button, get spaceless string. No ads, nonsense or garbage.
...
<span id="copy-to-clipboard">[![](../images/copy-to-clipboard.png "Copy to clipboard")](#)</span> <span id="remove-all-whitespace-submit-undo" class="undo">[(undo)](#)</span>

Want to remove only duplicate newline?

Use the [Remove Duplicate Whitespace tool](remove-whitespace)!
