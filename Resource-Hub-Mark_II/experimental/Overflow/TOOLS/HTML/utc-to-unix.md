utc-to-unix by HTTrack Website Copier/3.x \[XR&CO'2014\], Mon, 14 Dec 2020 03:25:42 GMT --&gt;
...
World's simplest UTC time to UNIX timestamp converter. Just paste the UTC time (actually any time format) in the form below, press Convert button, and you get Epoch time. Press button, get POSIX time. No ads, nonsense or garbage.
...
<span id="copy-to-clipboard">[![](../images/copy-to-clipboard.png "Copy to clipboard")](#)</span> <span id="utc-to-unix-submit-undo" class="undo">[(undo)](#)</span>

Want to convert UNIX time to UTC time instead?

Use the [UNIX time to UTC time converter tool](unix-to-utc)!
