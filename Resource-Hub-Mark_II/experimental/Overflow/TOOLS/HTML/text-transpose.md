text-transpose by HTTrack Website Copier/3.x \[XR&CO'2014\], Mon, 14 Dec 2020 03:25:40 GMT --&gt;
...
Transpose Text Files
====================

web developer and programmer tools
----------------------------------

World's simplest text rotator. Just paste your text or data in the form below, press Transpose Text button, and you get your text transposed. Press button, rotate text. No ads, nonsense or garbage.
...
<span id="copy-to-clipboard">[![](../images/copy-to-clipboard.png "Copy to clipboard")](#)</span> <span id="text-transpose-submit-undo" class="undo">[(undo)](#)</span>

Want to extract columns from text data?
...
Want to change text column separator?

Use the [Change Text Column Separator](change-delimiter) tool!
