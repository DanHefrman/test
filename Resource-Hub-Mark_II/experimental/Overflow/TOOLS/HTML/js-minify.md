js-minify by HTTrack Website Copier/3.x \[XR&CO'2014\], Mon, 14 Dec 2020 03:25:00 GMT --&gt;
...
World's simplest JavaScript minifier. Just paste your JS in the form below, press JS Minify button, and you get compressed JavaScript. Press button, get JS. No ads, nonsense or garbage.
...
<span id="copy-to-clipboard">[![](../images/copy-to-clipboard.png "Copy to clipboard")](#)</span> <span id="js-minify-submit-undo" class="undo">[(undo)](#)</span>

Want to prettify JavaScript?

Use the [JavaScript prettify tool](js-prettify)!
