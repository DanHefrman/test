xml-minify by HTTrack Website Copier/3.x \[XR&CO'2014\], Mon, 14 Dec 2020 03:25:03 GMT --&gt;
...
World's simplest XML minifier. Just paste your JS in the form below, press XML Minify button, and you get compressed XML. Press button, get XML. No ads, nonsense or garbage.
...
<span id="copy-to-clipboard">[![](../images/copy-to-clipboard.png "Copy to clipboard")](#)</span> <span id="xml-minify-submit-undo" class="undo">[(undo)](#)</span>

Want to prettify XML?

Use the [XML prettify tool](xml-prettify)!
