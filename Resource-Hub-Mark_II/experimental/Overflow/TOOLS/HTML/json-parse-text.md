...
World's simplest browser-based utility for JSON parsing text. Load your previously JSON stringified text in the input form on the left and you'll instantly get plain text in the output area. Powerful, free, and fast. Load stringified text – get plain text. Created by developers from team broowserools.
...
<span class="data-type">plain text</span> <span class="status"></span>
...
<span class="primary">Json text parser tool</span> <span class="secondary">What is a json text parser?</span>

With this tool you can perform the inverse operation of JSON stringify also sometimes called unstringify. The tool accepts only double quoted text and applies the JSON.parse() function to it. Textabulous!

<span class="primary">Json text parser examples</span> <span class="secondary">Click to use</span>

Jack Sparrow Quote

This example takes a previously JSON stringified text quote by Jack Sparrow from the movie Pirates of the Caribbean and as a result of unstringifies it. It removes backslashes before quotation marks and substitutes actual newlines for \\n characters \\n and tabs for \\t characters.

"\\"Gentlemen, m'lady, you will\\nalways remember this as the\\nday that you almost caught\\nCaptain Jack Sparrow.\\"\\n\\t\\tJack Sparrow"

"Gentlemen, m'lady, you will always remember this as the day that you almost caught Captain Jack Sparrow." Jack Sparrow

Unescape JavaScript Code

In this example, we parse a JSON string that contains JS code. All special JSON symbols get unescaped and we get code that we can evaluate.
...
<span class="muted"><span class="green">https://</span>onlinetexttools.com/json-parse-text</span><span class="underline">?input</span>=%22%5C%22Gentlemen%2C%20m%27lady%2C%20you%20will%5Cnalways%20remember%20this%20as%20the%5Cnday%20that%20you%20almost%20caught%5CnCaptain%20Jack%20Sparrow.%5C%22%5Cn%5Ct%5CtJack%20Sparrow%22
