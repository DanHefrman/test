...
Free online random XML file generator. Just press a button and get your random XML document. There are no ads, popups or nonsense, just a random XML data structure creator. Press a button, get a random XML. Created by developers from team broowserools.
...
<span class="data-type">random xml</span> <span class="status"></span>
...
Generate a new random XML document

Random xml doc generator options

<span class="option-group-legend">Generator Options</span>

XML depth <span class="option-details">Maximum XML depth</span>
...
Use random English words <span class="option-details">Use random English words for tags and content</span>

Use completely random strings <span class="option-details">Use randomly generated characters for tags and content</span>

Maximum string length <span class="option-details">Maximum random string length? (Only works with random strings.)</span>

<span class="option-group-legend">XML Options</span>

Wrapper tag <span class="option-details">Name of the wrapper tag Uses &lt;root&gt; by default</span>

Use XML meta tags <span class="option-details">Puts &lt;?xml&gt; as the first tag</span>

Generate attributes <span class="option-details">Randomly appends attributes</span>

Generate CDATA <span class="option-details">Randomly generates valid &lt;!\[CDATA\[\]\]&gt; sections</span>

Generate comments <span class="option-details">Occasionally puts random &lt;!-- comment --&gt; sections</span>
...
<span class="primary">Random xml doc generator tool</span> <span class="secondary">What is a random xml doc generator?</span>
...
<span class="primary">Random xml doc generator examples</span> <span class="secondary">Click to use</span>
...
<span class="muted"><span class="green">https://</span>onlinerandomtools.com/generate-random-xml</span>?&depth=1&max-elements=10&always-max-elements=true
