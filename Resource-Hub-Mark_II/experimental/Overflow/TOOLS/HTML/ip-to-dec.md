ip-to-dec by HTTrack Website Copier/3.x \[XR&CO'2014\], Mon, 14 Dec 2020 03:25:45 GMT --&gt;
...
World's simplest IP to integer converter. Just paste your IP address in the form below, press Convert button, and you get IP in decimal representation. Press button, get IP decimal. No ads, nonsense or garbage. Useful if you store your IP address data as integers in your database.
...
<span id="copy-to-clipboard">[![](../images/copy-to-clipboard.png "Copy to clipboard")](#)</span> <span id="ip-to-dec-submit-undo" class="undo">[(undo)](#)</span>

Want to convert decimal to IP instead?

Use the [Decimal to IP converter tool](dec-to-ip)!
