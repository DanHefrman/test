letter-frequency by HTTrack Website Copier/3.x \[XR&CO'2014\], Mon, 14 Dec 2020 03:28:57 GMT --&gt;
...
World's simplest letter frequency calculator. Just paste your text in the form below, press Calculate Letter Frequency button, and you get letter statistics. Press button, get letter count. No ads, nonsense or garbage.
...
<span id="copy-to-clipboard">[![](../images/copy-to-clipboard.png "Copy to clipboard")](#)</span> <span id="letter-frequency-submit-undo" class="undo">[(undo)](#)</span>

Want to find word frequency in text?

Use the [Word frequency tool](word-frequency)!

Want to count letters in text?

Use the [Letter counter tool](letter-count)!
