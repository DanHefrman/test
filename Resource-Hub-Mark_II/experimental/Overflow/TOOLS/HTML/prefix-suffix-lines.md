prefix-suffix-lines by HTTrack Website Copier/3.x \[XR&CO'2014\], Mon, 14 Dec 2020 03:29:00 GMT --&gt;
...
Append Text to Beginning and End of Lines
=========================================

web developer and programmer tools
----------------------------------

World's simplest text appender. Just paste your text in the form below, enter prefix and suffix, press Append Prefix and Suffix button, and you get appended strings. Press button, get prefixes and suffixes. No ads, nonsense or garbage.
...
<span id="copy-to-clipboard">[![](../images/copy-to-clipboard.png "Copy to clipboard")](#)</span> <span id="prefix-suffix-lines-submit-undo" class="undo">[(undo)](#)</span>
