...
Text palindrome creator
=======================

World"s simplest text tool
--------------------------

World"s simplest browser-based utility for creating palindromes from text. Load your text in the input form on the left and you"ll instantly get a palindrome in the output area. Powerful, free, and fast. Load plain text – get its palindrome. Created by developers from team broowserools.
...
<span class="data-type">palindrome text</span> <span class="status"></span>
...
Text palindrome creator options

<span class="option-group-legend">Type of Symmetry</span>

Centered Text <span class="option-details">Don"t duplicate the last letter.</span>

Mirrored Text <span class="option-details">Duplicate all letters.</span>

<span class="option-group-legend">Multiple Palindromes</span>

Line-by-line Mode <span class="option-details">Create a palindrome for each text row.</span>

<span class="primary">Text palindrome creator tool</span> <span class="secondary">What is a text palindrome creator?</span>

With this tool, you can create a palindrome of the given text. A palindrome is a sequence of symbols that reads the same from both ends. To do it, this tool first reverses all characters in text and then appends this to itself. As a result, you get a symmetrical text that you can read from both sides and it will say the same thing. We distinguish between two types of palindromes – centered and mirrored. If you create a centered palindrome, then the last character of the input text is not duplicated. For example, the word "taco" is transformed into the palindrome "tacocat". If you create a mirrored palindrome, then it duplicates all letters, including the last one. In this case, the word "taco" becomes "tacoocat". You can also construct several palindromes at the same time by using the line-by-line mode. Textabulous!

<span class="primary">Text palindrome creator examples</span> <span class="secondary">Click to use</span>

Short Palindrome

In this example, we build a palindrome from a short text phrase. At the end of the input text, we"ve added an extra space so that the palindrome copy does not merge with the original copy. If you look closely, you"ll see that the last space is not duplicated in the output palindrome because the option "Centered Text" is activated. This option ignores the last character when creating the palindrome.
...
In this example, we create a palindrome from a famous Albert Einstein"s quote. At the end of the quote, there"s a newline and as we"ve selected the "Mirrored Text" symmetry mode, this newline gets duplicated. As a result, the palindrome appears on a separate paragraph for better readability.

Learn from yesterday, live for today, hope for tomorrow.

Learn from yesterday, live for today, hope for tomorrow. .worromot rof epoh ,yadot rof evil ,yadretsey morf nraeL
...
This example constructs several palindromes at once. Each palindrome is created separately from each text row. This is done by turning on the line-by-line function. The tool works not only with letters but also with numbers and all other characters.

WOOooo 1 + 1 = .. ♪♫•\*¨❤\*•.¸¸

WOOooooooOOW 1 + 1 = .... = 1 + 1 ♪♫•\*¨❤\*•.¸¸¸¸.•\*❤¨\*•♫♪
...
<span class="muted"><span class="green">https://</span>onlinetexttools.com/create-text-palindrome</span><span class="underline">?input</span>=have%20a%20nice%20day%20&centered-text=true
