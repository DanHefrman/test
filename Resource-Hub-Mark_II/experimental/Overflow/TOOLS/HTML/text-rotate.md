text-rotate by HTTrack Website Copier/3.x \[XR&CO'2014\], Mon, 14 Dec 2020 03:28:44 GMT --&gt;
...
World's simplest circular string character rotator. Just paste your text in the form below, press Rotate String button, and you get text circularly rotated char by char. Press button, rotate text. No ads, nonsense or garbage.
...
Text rotation direction: Left Right

<span id="copy-to-clipboard">[![](../images/copy-to-clipboard.png "Copy to clipboard")](#)</span> <span id="text-rotate-submit-undo" class="undo">[(undo)](#)</span>

Want to reverse strings?

Use the [String Reverse tool](text-reverse)!
