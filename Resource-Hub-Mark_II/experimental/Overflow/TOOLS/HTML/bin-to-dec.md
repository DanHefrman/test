bin-to-dec by HTTrack Website Copier/3.x \[XR&CO"2014\], Mon, 14 Dec 2020 03:29:18 GMT --&gt;
...
World"s simplest binary converter. Just paste your bin number in the form below, press Convert button, and you get an decimal integer in base 10. Press button, get decimal. No ads, nonsense or garbage.
...
<span id="copy-to-clipboard">[![](../images/copy-to-clipboard.png "Copy to clipboard")](#)</span> <span id="bin-to-dec-submit-undo" class="undo">[(undo)](#)</span>

Want to convert decimal to binary?

Use the [Dec to bin converter](dec-to-bin)!
