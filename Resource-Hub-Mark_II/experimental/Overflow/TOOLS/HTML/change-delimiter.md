change-delimiter by HTTrack Website Copier/3.x \[XR&CO"2014\], Mon, 14 Dec 2020 03:25:39 GMT --&gt;

<span id="top"></span>

src="../images/broowserools-logo-cross-browser-testing.png" alt="Cross-browser testing"&gt;

Change Text Column Separator
============================

web developer and programmer tools
----------------------------------

World"s simplest text column separator changer. Just paste your text data columns in the form below, press Change Delimiter button, and spaces that separate data columns get changed to your new delimiter. Press button, change delimiter. No ads, nonsense or garbage.
...
Old delimiter: (space by default)

New delimiter:

<span id="copy-to-clipboard">[![](../images/copy-to-clipboard.png "Copy to clipboard")](#)</span> <span id="change-delimiter-submit-undo" class="undo">[(undo)](#)</span>

Want to extract columns from text?

Use the [Extract Text Columns](extract-column) tool!

Want to swap text columns?

Use the [Swap Text Columns](swap-columns) tool!

Want to transpose text?
