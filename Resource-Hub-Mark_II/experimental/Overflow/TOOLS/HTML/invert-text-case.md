...
World"s simplest browser-based utility for inverting letter case in text. Load your text in the input form on the left and you"ll instantly get back an inverted case version in the output area. Powerful, free, and fast. Load text – get its case inverted. Created by developers from team broowserools.
...
<span class="data-type">inverted case text</span> <span class="status"></span>
...
<span class="primary">Text case inverter tool</span> <span class="secondary">What is a text case inverter?</span>

With this tool you can invert the case of characters in text. For each letter of the text, the opposite case will be selected (instead of uppercase - lowercase, instead of lowercase - uppercase). Textabulous!

<span class="primary">Text case inverter examples</span> <span class="secondary">Click to use</span>

Invert Text Case

In this example, we swap upper and lower case letters.

i want all letters of this text to be in uppercase, EXCEPT FOR THIS PIECE.
...
<span class="muted"><span class="green">https://</span>onlinetexttools.com/invert-text-case</span><span class="underline">?input</span>=i%20want%20all%20letters%20of%20this%20text%20to%20be%20in%20uppercase%2C%20EXCEPT%20FOR%20THIS%20PIECE.
