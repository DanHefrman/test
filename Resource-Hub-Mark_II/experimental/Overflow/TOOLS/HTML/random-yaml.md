random-yaml by HTTrack Website Copier/3.x \[XR&CO'2014\], Mon, 14 Dec 2020 03:29:12 GMT --&gt;
...
World's simplest random YAML generator. Just press Generate YAML button, and you get a random YAML configuration. Press button, get YAML. No ads, nonsense or garbage.
...
<span id="copy-to-clipboard">[![](../images/copy-to-clipboard.png "Copy to clipboard")](#)</span> <span id="random-yaml-submit-undo" class="undo">[(undo)](#)</span>
