ascii-to-text by HTTrack Website Copier/3.x \[XR&CO"2014\], Mon, 14 Dec 2020 03:25:53 GMT --&gt;
...
<span id="copy-to-clipboard">[![](../images/copy-to-clipboard.png "Copy to clipboard")](#)</span> <span id="ascii-to-text-submit-undo" class="undo">[(undo)](#)</span>

Want to convert text to ASCII?

Use the [Text to ASCII converter](text-to-ascii)!
