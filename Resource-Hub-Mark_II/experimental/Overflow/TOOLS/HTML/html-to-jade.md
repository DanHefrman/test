html-to-jade by HTTrack Website Copier/3.x \[XR&CO"2014\], Mon, 14 Dec 2020 03:25:06 GMT --&gt;
...
World"s simplest HTML to Jade translator. Just paste your HTML in the form below, press Convert button, and you get Jade markup. Press button, get Jade. No ads, nonsense or garbage.
...
<span id="copy-to-clipboard">[![](../images/copy-to-clipboard.png "Copy to clipboard")](#)</span> <span id="html-to-jade-submit-undo" class="undo">[(undo)](#)</span>

Want to convert Jade to HTML?

Use the [Jade to HTML converter tool](jade-to-html)!
