xml-to-json by HTTrack Website Copier/3.x \[XR&CO'2014\], Mon, 14 Dec 2020 03:25:14 GMT --&gt;
...
World's simplest XML to JSON converter. Just paste your XML in the form below, press Convert button, and you get JSON. Press button, get JSON. No ads, nonsense or garbage.
...
<span id="copy-to-clipboard">[![](../images/copy-to-clipboard.png "Copy to clipboard")](#)</span> <span id="xml-to-json-submit-undo" class="undo">[(undo)](#)</span>

Want to convert JSON to XML instead?

Use the [JSON to XML converter tool](json-to-xml)!
