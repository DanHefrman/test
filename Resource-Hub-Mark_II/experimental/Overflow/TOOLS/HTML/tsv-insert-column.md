tsv-insert-column by HTTrack Website Copier/3.x \[XR&CO'2014\], Mon, 14 Dec 2020 03:25:35 GMT --&gt;
...
Insert a TSV Column in Existing TSV
===================================

web developer and programmer tools
----------------------------------

World's simplest online TSV column inserter. Just paste your TSV and the new column in the forms below, press Insert TSV Column button, and you the new column gets inserted at the given position. Press button, insert column. No ads, nonsense or garbage.
...
Position to insert: (1 for beginning, -1 for end)

New column (including new column's title):

<span id="copy-to-clipboard">[![](../images/copy-to-clipboard.png "Copy to clipboard")](#)</span> <span id="tsv-insert-column-submit-undo" class="undo">[(undo)](#)</span>
