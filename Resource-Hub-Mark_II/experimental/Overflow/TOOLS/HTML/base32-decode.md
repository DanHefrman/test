base32-decode by HTTrack Website Copier/3.x \[XR&CO"2014\], Mon, 14 Dec 2020 03:25:58 GMT --&gt;
...
World"s simplest base32 decode. Just paste your data in the form below, press Base32 Decode button, and you get a base32 decoded string. Press button, get string. No ads, nonsense or garbage.
...
<span id="copy-to-clipboard">[![](../images/copy-to-clipboard.png "Copy to clipboard")](#)</span> <span id="base32-decode-submit-undo" class="undo">[(undo)](#)</span>

Want to base32 encode?

Use the [base32 encoder tool](base32-encode)!
