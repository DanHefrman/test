tsv-to-text by HTTrack Website Copier/3.x \[XR&CO'2014\], Mon, 14 Dec 2020 03:25:25 GMT --&gt;
...
World's simplest TSV to text converter. Just paste your tab separated values in the form below, press Convert TSV to Text button, and you get text columns. Press button, get columns. No ads, nonsense or garbage.
...
<span id="copy-to-clipboard">[![](../images/copy-to-clipboard.png "Copy to clipboard")](#)</span> <span id="tsv-to-text-submit-undo" class="undo">[(undo)](#)</span>

Want to convert text columns to TSV instead?

Use the [Text to TSV converter tool](text-to-tsv)!
