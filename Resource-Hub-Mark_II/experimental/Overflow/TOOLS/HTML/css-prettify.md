css-prettify by HTTrack Website Copier/3.x \[XR&CO"2014\], Mon, 14 Dec 2020 03:25:01 GMT --&gt;
...
World"s simplest CSS beautifier. Just paste your CSS in the form below, press CSS Prettify button, and you get beautiful and clean CSS. Press button, get CSS. No ads, nonsense or garbage.
...
<span id="copy-to-clipboard">[![](../images/copy-to-clipboard.png "Copy to clipboard")](#)</span> <span id="css-prettify-submit-undo" class="undo">[(undo)](#)</span>

Want to minify CSS?

Use the [CSS minifier tool](css-minify)!
