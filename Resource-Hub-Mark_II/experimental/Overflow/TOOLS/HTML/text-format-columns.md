text-format-columns by HTTrack Website Copier/3.x \[XR&CO'2014\], Mon, 14 Dec 2020 03:28:53 GMT --&gt;
...
World's simplest online string column aligner. Just paste your column data in the form below, press Align Columns button, and all columns get neatly formatted. Press button, format columns. No ads, nonsense or garbage.
...
Alignment format: (In Progress, for now just left-align)

<span id="copy-to-clipboard">[![](../images/copy-to-clipboard.png "Copy to clipboard")](#)</span> <span id="text-format-columns-submit-undo" class="undo">[(undo)](#)</span>
