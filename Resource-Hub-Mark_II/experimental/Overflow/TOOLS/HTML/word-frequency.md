word-frequency by HTTrack Website Copier/3.x \[XR&CO'2014\], Mon, 14 Dec 2020 03:28:58 GMT --&gt;
...
<span id="copy-to-clipboard">[![](../images/copy-to-clipboard.png "Copy to clipboard")](#)</span> <span id="word-frequency-submit-undo" class="undo">[(undo)](#)</span>

Want to find number of words in text?

Use the [Word counter tool](word-count)!
